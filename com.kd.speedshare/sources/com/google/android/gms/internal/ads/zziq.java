...
public final class zziq {
    ...
    public final long zzj(boolean z) {
        ...
        if (this.zzaez.zzaht == 1.0f) {
            ...
            if (!this.zzajt.isEmpty() || this.zzajn.zzgk() < 1024) {
                j3 = this.zzakc;
                double d = (double) this.zzaez.zzaht;
                double d2 = (double) (j - this.zzakd);
                Double.isNaN(d);
                Double.isNaN(d2);
                j4 = (long) (d * d2);
            } else {
    ...
    public final boolean zzb(ByteBuffer byteBuffer, long j) throws zzit, zziy {
        ...
        zzpb.checkArgument(byteBuffer3 == null || byteBuffer2 == byteBuffer3);
        if (!isInitialized()) {
            this.zzajq.block();
            if (this.zzali) {
        ...
        if (this.zzala == null) {
            ...
            if (this.zzakb != null) {
                ...
                LinkedList<zziv> linkedList = this.zzajt;
                zziv zziv = r11;
                zziv zziv2 = new zziv(this.zzakb, Math.max(0, j2), zzdw(zzfu()), (zzip) null);
                linkedList.add(zziv);
                this.zzakb = null;
                zzfm();
            }
            if (this.zzaku == 0) {
                ...
                if (this.zzaku != 1 || Math.abs(zzdw - j2) <= 200000) {
                    i = 2;
                } else {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static int zzay(java.lang.String r5) {
        /*
            int r0 = r5.hashCode()
            r1 = 0
            r2 = 3
        ...
        L_0x0045:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zziq.zzay(java.lang.String):int");
    }
}
