...
final class zzdqz implements zzdpp {
    ...
    public final synchronized boolean zzavq() throws zzdrj {
        try {
            ...
            throw new zzdrj(2001, (Throwable) e);
        }
    ...
    public final synchronized void close() throws zzdrj {
        try {
            ...
            throw new zzdrj(2003, (Throwable) e);
        }
    }
    ...
    public final synchronized String zza(Context context, String str, String str2, View view, Activity activity) {
        ...
        zzcg.put("cs", str2);
        zzcg.put("aid", (Object) null);
        zzcg.put("view", view);
        zzcg.put("act", activity);
        return zzk(zzb((Map<String, String>) null, zzcg));
    }
    ...
    public final synchronized void zza(String str, MotionEvent motionEvent) throws zzdrj {
        try {
            ...
            this.zzhjf.getClass().getDeclaredMethod("he", new Class[]{Map.class}).invoke(this.zzhjf, new Object[]{hashMap});
            this.zzvv.zzg(3003, System.currentTimeMillis() - currentTimeMillis);
        } catch (Exception e) {
            throw new zzdrj(2005, (Throwable) e);
        }
    }
    ...
    public final synchronized int zzavr() throws zzdrj {
        try {
            ...
            throw new zzdrj(2006, (Throwable) e);
        }
    ...
    private final synchronized byte[] zzb(Map<String, String> map, Map<String, Object> map2) {
        ...
        try {
            ...
            this.zzvv.zza(2007, System.currentTimeMillis() - currentTimeMillis, e);
            return null;
        }
        return (byte[]) this.zzhjf.getClass().getDeclaredMethod("xss", new Class[]{Map.class, Map.class}).invoke(this.zzhjf, new Object[]{null, map2});
    }
}
