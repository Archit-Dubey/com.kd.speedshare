...
public final class zzacq {
    public static zzabx<Long> zzdau = zzabx.zzb("gads:dynamite_load:fail:sample_rate", 10000);
    public static zzabx<Boolean> zzdav = zzabx.zzf("gads:report_dynamite_crash_in_background_thread", false);
    public static zzabx<String> zzdaw = zzabx.zzi("gads:public_beta:traffic_multiplier", "1.0");
