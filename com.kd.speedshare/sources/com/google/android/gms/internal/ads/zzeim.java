...
class zzeim<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public boolean containsKey(Object obj) {
        ...
        return zza(comparable) >= 0 || this.zziim.containsKey(comparable);
    }
    ...
    public V get(Object obj) {
        ...
        return this.zziim.get(comparable);
    }
    ...
    public final V put(K k, V v) {
        ...
        if (size == i2) {
            ...
            zzbhn().put((Comparable) remove.getKey(), remove.getValue());
        }
    ...
    public V remove(Object obj) {
        ...
        return this.zziim.remove(comparable);
    }
    ...
    public final V zzhp(int i) {
        ...
        if (!this.zziim.isEmpty()) {
            Iterator it = zzbhn().entrySet().iterator();
            this.zziil.add(new zzeir(this, (Map.Entry) it.next()));
            it.remove();
        }
        return value;
    }
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.zziin == null) {
            this.zziin = new zzeit(this, (zzeil) null);
        }
        return this.zziin;
    }
    ...
    public final Set<Map.Entry<K, V>> zzbhl() {
        if (this.zziip == null) {
            this.zziip = new zzein(this, (zzeil) null);
        }
        return this.zziip;
    }
