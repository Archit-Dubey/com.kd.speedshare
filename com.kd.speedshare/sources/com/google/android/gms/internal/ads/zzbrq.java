...
public final class zzbrq {
    ...
    public final zzdvf<zzasm> zzait() {
        ...
        return this.zzfpw.zza(zzdor.REQUEST_PARCEL, (zzdvf<?>[]) new zzdvf[]{zzais, this.zzfqv.get()}).zzb(new zzbrt(this, zzais)).zzaus();
    }

    /* access modifiers changed from: package-private */
    public final /* synthetic */ zzasm zzc(zzdvf zzdvf) throws Exception {
        return new zzasm((Bundle) zzdvf.get(), this.zzbov, this.zzfqu, this.packageName, this.zzdpu, this.zzdpk, (String) this.zzfqv.get().get(), this.zzdyn.zzwx(), this.zzdss, (zzdms) null, (String) null);
    }
}
