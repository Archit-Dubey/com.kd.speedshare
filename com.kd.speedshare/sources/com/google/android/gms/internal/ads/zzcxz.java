...
public final class zzcxz extends zzawu {
    private static final List<String> zzgqp = new ArrayList(Arrays.asList(new String[]{"/aclk", "/pcs/click"}));
    private static final List<String> zzgqq = new ArrayList(Arrays.asList(new String[]{".doubleclick.net", ".googleadservices.com"}));
    private static final List<String> zzgqr = new ArrayList(Arrays.asList(new String[]{"/pagead/adview", "/pcs/view", "/pagead/conversion"}));
    private static final List<String> zzgqs = new ArrayList(Arrays.asList(new String[]{".doubleclick.net", ".googleadservices.com", ".googlesyndication.com"}));
    ...
    public final void zza(List<Uri> list, IObjectWrapper iObjectWrapper, zzaqz zzaqz) {
        if (!((Boolean) zzwg.zzpw().zzd(zzaav.zzcwu)).booleanValue()) {
            ...
            if (zzaqi()) {
                zze = zzdux.zzb(zze, new zzcyb(this), (Executor) this.zzgad);
            } else {
    ...
    public final void zzb(List<Uri> list, IObjectWrapper iObjectWrapper, zzaqz zzaqz) {
        try {
            if (!((Boolean) zzwg.zzpw().zzd(zzaav.zzcwu)).booleanValue()) {
                ...
                if (zzaqi()) {
                    zze = zzdux.zzb(zze, new zzcyd(this), (Executor) this.zzgad);
                } else {
                    zzaxv.zzfc("Asset view map is empty.");
                }
    ...
    public final Uri zzb(Uri uri, IObjectWrapper iObjectWrapper) throws Exception {
        try {
            uri = this.zzfkq.zza(uri, this.zzvr, (View) ObjectWrapper.unwrap(iObjectWrapper), (Activity) null);
        } catch (zzef e) {
            zzbba.zzd("", e);
        }
    ...
    private final zzdvf<String> zzgq(String str) {
        ...
        zzdvf<O> zzb = zzdux.zzb(this.zzglw.zzass(), new zzcyg(this, zzcgrArr, str), (Executor) this.zzgad);
        zzb.addListener(new zzcyj(this, zzcgrArr), this.zzgad);
        return zzduo.zzg(zzb).zza((long) ((Integer) zzwg.zzpw().zzd(zzaav.zzcwv)).intValue(), TimeUnit.MILLISECONDS, this.zzfkm).zza(zzcye.zzdvt, this.zzgad).zza(Exception.class, zzcyh.zzdvt, (Executor) this.zzgad);
    }
    ...
    public final /* synthetic */ zzdvf zza(zzcgr[] zzcgrArr, String str, zzcgr zzcgr) throws Exception {
        ...
        jSONObject.put("asset_view_signal", (Object) zza);
        jSONObject.put("ad_view_signal", (Object) zza2);
        jSONObject.put("scroll_view_signal", (Object) zzt);
        jSONObject.put("lock_screen_signal", (Object) zzb);
        if (str == "google.afma.nativeAds.getPublisherCustomRenderedClickSignals") {
            jSONObject.put("click_signal", (Object) zzbae.zza((String) null, this.zzvr, this.zzfvf, this.zzfve));
        }
    ...
    public final /* synthetic */ zzdvf zzl(Uri uri) throws Exception {
        return zzdux.zzb(zzgq("google.afma.nativeAds.getPublisherCustomRenderedClickSignals"), new zzcyf(this, uri), (Executor) this.zzgad);
    }

    /* access modifiers changed from: package-private */
    public final /* synthetic */ zzdvf zzb(ArrayList arrayList) throws Exception {
        return zzdux.zzb(zzgq("google.afma.nativeAds.getPublisherCustomRenderedImpressionSignals"), new zzcyc(this, arrayList), (Executor) this.zzgad);
    }
