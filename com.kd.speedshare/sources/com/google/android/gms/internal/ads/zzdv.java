...
public abstract class zzdv implements zzdw {
    ...
    /* access modifiers changed from: protected */
    public abstract zzcf.zza.C0003zza zza(Context context, zzby.zza zza);

    /* access modifiers changed from: protected */
    public abstract zzcf.zza.C0003zza zzb(Context context, View view, Activity activity);
    ...
    /* access modifiers changed from: protected */
    public abstract zzcf.zza.C0003zza zzc(Context context, View view, Activity activity);
    ...
    public void zza(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            Double.isNaN(rawY);
            double d4 = rawY - d3;
            this.zzwt += Math.sqrt((d2 * d2) + (d4 * d4));
            this.zzwu = rawX;
            this.zzwv = rawY;
        }
    ...
    private final void zzby() {
        ...
        this.zzws = 0;
        if (this.zzwl.size() > 0) {
            Iterator it = this.zzwl.iterator();
            while (it.hasNext()) {
        ...
        try {
            ...
            if (booleanValue && zzdu != null) {
                if (i6 == zzcw.zznp) {
                    ...
                    i4 = i6 == zzcw.zznn ? PointerIconCompat.TYPE_CONTEXT_MENU : -1;
                }
