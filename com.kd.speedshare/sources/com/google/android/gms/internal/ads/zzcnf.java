...
public final class zzcnf {
    ...
    public final zzdvf<InputStream> zzg(zzasm zzasm) {
        ...
        return zzduo.zzg(zzdvf).zza((long) ((Integer) zzwg.zzpw().zzd(zzaav.zzcug)).intValue(), TimeUnit.SECONDS, this.zzfkm).zza(Throwable.class, new zzcne(this, zzasm, callingUid), (Executor) this.zzgad);
    }
