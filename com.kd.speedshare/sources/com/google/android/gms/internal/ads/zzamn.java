...
public final class zzamn {
    ...
    public zzamn(JSONObject jSONObject) throws JSONException {
        ...
        this.zzdjb = jSONObject.optString("allocation_id", (String) null);
        zzq.zzlo();
        ...
        this.zzdjo = jSONObject.optString("html_template", (String) null);
        this.zzdjp = jSONObject.optString("ad_base_url", (String) null);
        ...
        this.zzdjt = jSONObject.optString("response_type", (String) null);
