...
public final class zzbpi {
    ...
    public final void zza(List<? extends zzdvf<? extends zzbpb>> list, zzduu<zzbpb> zzduu) {
        ...
        zzdvf<O> zzaf = zzdux.zzaf(null);
        for (zzdvf zzbpn : list) {
            zzaf = zzdux.zzb(zzdux.zzb(zzaf, Throwable.class, new zzbpk(zzduu), this.executor), new zzbpn(this, zzduu, zzbpn), this.executor);
        }
