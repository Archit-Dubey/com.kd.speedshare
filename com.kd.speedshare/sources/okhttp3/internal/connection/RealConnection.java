...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    public void connect(int r16, int r17, int r18, boolean r19, okhttp3.Call r20, okhttp3.EventListener r21) {
        ...
        L_0x0073:
            ...
            r12 = r11
        L_0x0075:
            okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x00e1 }
            boolean r0 = r0.requiresTunnel()     // Catch:{ IOException -> 0x00e1 }
            ...
            java.net.Socket r0 = r7.rawSocket     // Catch:{ IOException -> 0x00e1 }
        ...
        L_0x0095:
            r13 = r16
            r14 = r17
            r15.connectSocket(r13, r14, r8, r9)     // Catch:{ IOException -> 0x00df }
        L_0x009c:
            r15.establishProtocol(r10, r8, r9)     // Catch:{ IOException -> 0x00df }
            okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x00df }
            java.net.InetSocketAddress r0 = r0.socketAddress()     // Catch:{ IOException -> 0x00df }
            okhttp3.Route r1 = r7.route     // Catch:{ IOException -> 0x00df }
            java.net.Proxy r1 = r1.proxy()     // Catch:{ IOException -> 0x00df }
            okhttp3.Protocol r2 = r7.protocol     // Catch:{ IOException -> 0x00df }
        ...
        L_0x00ca:
            ...
            monitor-enter(r1)
            okhttp3.internal.http2.Http2Connection r0 = r7.http2Connection     // Catch:{ all -> 0x00db }
            int r0 = r0.maxConcurrentStreams()     // Catch:{ all -> 0x00db }
    ...
    private void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r8) throws java.io.IOException {
        /*
            ...
            r2 = 0
            java.net.Socket r3 = r7.rawSocket     // Catch:{ AssertionError -> 0x010c }
            okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x010c }
            java.lang.String r4 = r4.host()     // Catch:{ AssertionError -> 0x010c }
            okhttp3.HttpUrl r5 = r0.url()     // Catch:{ AssertionError -> 0x010c }
            int r5 = r5.port()     // Catch:{ AssertionError -> 0x010c }
            r6 = 1
            java.net.Socket r1 = r1.createSocket(r3, r4, r5, r6)     // Catch:{ AssertionError -> 0x010c }
            javax.net.ssl.SSLSocket r1 = (javax.net.ssl.SSLSocket) r1     // Catch:{ AssertionError -> 0x010c }
            okhttp3.ConnectionSpec r8 = r8.configureSecureSocket(r1)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            boolean r3 = r8.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            if (r3 == 0) goto L_0x0041
            okhttp3.internal.platform.Platform r3 = okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            okhttp3.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.lang.String r4 = r4.host()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.util.List r5 = r0.protocols()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            r3.configureTlsExtensions(r1, r4, r5)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
        L_0x0041:
            r1.startHandshake()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            javax.net.ssl.SSLSession r3 = r1.getSession()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            okhttp3.Handshake r3 = okhttp3.Handshake.get(r3)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            javax.net.ssl.HostnameVerifier r4 = r0.hostnameVerifier()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            okhttp3.HttpUrl r5 = r0.url()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.lang.String r5 = r5.host()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            javax.net.ssl.SSLSession r6 = r1.getSession()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            boolean r4 = r4.verify(r5, r6)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            if (r4 == 0) goto L_0x00b2
            okhttp3.CertificatePinner r4 = r0.certificatePinner()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.lang.String r0 = r0.host()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.util.List r5 = r3.peerCertificates()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            r4.check((java.lang.String) r0, (java.util.List<java.security.cert.Certificate>) r5)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            boolean r8 = r8.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            if (r8 == 0) goto L_0x0083
            okhttp3.internal.platform.Platform r8 = okhttp3.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.lang.String r2 = r8.getSelectedProtocol(r1)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
        L_0x0083:
            r7.socket = r1     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            okio.Source r8 = okio.Okio.source((java.net.Socket) r1)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            okio.BufferedSource r8 = okio.Okio.buffer((okio.Source) r8)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            r7.source = r8     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            okio.Sink r8 = okio.Okio.sink((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            okio.BufferedSink r8 = okio.Okio.buffer((okio.Sink) r8)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            r7.sink = r8     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            r7.handshake = r3     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            if (r2 == 0) goto L_0x00a4
            okhttp3.Protocol r8 = okhttp3.Protocol.get(r2)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            goto L_0x00a6
        L_0x00a4:
            okhttp3.Protocol r8 = okhttp3.Protocol.HTTP_1_1     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
        L_0x00a6:
            r7.protocol = r8     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
        ...
        L_0x00b1:
            return
        L_0x00b2:
            java.util.List r8 = r3.peerCertificates()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            r2 = 0
            java.lang.Object r8 = r8.get(r2)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.security.cert.X509Certificate r8 = (java.security.cert.X509Certificate) r8     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            javax.net.ssl.SSLPeerUnverifiedException r2 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            r3.<init>()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.lang.String r4 = "Hostname "
            r3.append(r4)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            okhttp3.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.lang.String r0 = r0.host()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            r3.append(r0)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.lang.String r0 = " not verified:\n    certificate: "
            r3.append(r0)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.lang.String r0 = okhttp3.CertificatePinner.pin(r8)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            r3.append(r0)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.lang.String r0 = "\n    DN: "
            r3.append(r0)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.security.Principal r0 = r8.getSubjectDN()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.lang.String r0 = r0.getName()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            r3.append(r0)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.lang.String r0 = "\n    subjectAltNames: "
            r3.append(r0)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.util.List r8 = okhttp3.internal.tls.OkHostnameVerifier.allSubjectAltNames(r8)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            r3.append(r8)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            java.lang.String r8 = r3.toString()     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            r2.<init>(r8)     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
            throw r2     // Catch:{ AssertionError -> 0x0107, all -> 0x0104 }
        L_0x0104:
            r8 = move-exception
            r2 = r1
            goto L_0x011a
        ...
        L_0x010c:
            r8 = move-exception
        L_0x010d:
            boolean r0 = okhttp3.internal.Util.isAndroidGetsocknameError(r8)     // Catch:{ all -> 0x010a }
            if (r0 == 0) goto L_0x0119
            java.io.IOException r0 = new java.io.IOException     // Catch:{ all -> 0x010a }
            r0.<init>(r8)     // Catch:{ all -> 0x010a }
