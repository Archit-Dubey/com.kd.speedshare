...
public final class zzri extends Thread {
    ...
    public final void run() {
        ...
        L_0x004c:
            ...
            goto L_0x0062
        L_0x0051:
            com.google.android.gms.internal.ads.zzrl r0 = new com.google.android.gms.internal.ads.zzrl     // Catch:{ InterruptedException -> 0x007b, Exception -> 0x006b }
        ...
        L_0x005a:
            ...
            r4.zzmk()     // Catch:{ InterruptedException -> 0x007b, Exception -> 0x006b }
        L_0x0062:
            int r0 = r4.zzbsz     // Catch:{ InterruptedException -> 0x007b, Exception -> 0x006b }
            int r0 = r0 * 1000
    ...
    public final void zza(zzrc zzrc, WebView webView, String str, boolean z) {
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                String optString = new JSONObject(str).optString(AccessDatabase.FIELD_CLIPBOARD_TEXT);
