...
public final class zzaze {
    ...
    private static String zzh(Context context, String str, String str2) {
        ...
        hashMap.put(HttpRequest.HEADER_USER_AGENT, zzq.zzkw().zzs(context, str2));
        zzdvf<String> zzc = new zzazq(context).zzc(str, hashMap);
        try {
            return (String) zzc.get((long) ((Integer) zzwg.zzpw().zzd(zzaav.zzcsy)).intValue(), TimeUnit.MILLISECONDS);
