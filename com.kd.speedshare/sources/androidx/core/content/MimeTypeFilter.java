...
public final class MimeTypeFilter {
    ...
    private static boolean mimeTypeAgainstFilter(String[] strArr, String[] strArr2) {
        if (strArr2.length != 2) {
            ...
            if (!ShareableListFragment.MIMEGrouper.TYPE_GENERIC.equals(strArr2[0]) && !strArr2[0].equals(strArr[0])) {
                return false;
            }
            if (ShareableListFragment.MIMEGrouper.TYPE_GENERIC.equals(strArr2[1]) || strArr2[1].equals(strArr[1])) {
                return true;
            }
            return false;
        }
