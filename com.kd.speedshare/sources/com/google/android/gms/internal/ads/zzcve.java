...
public final class zzcve<AdT, AdapterT, ListenerT extends zzbtt> implements zzcqt<AdT> {
    ...
    public final zzdvf<AdT> zzb(zzdkw zzdkw, zzdkk zzdkk) {
        ...
        Iterator<String> it = zzdkk.zzgzs.iterator();
        while (true) {
            if (!it.hasNext()) {
                zzcqv = null;
                break;
            ...
            try {
                zzcqv = this.zzfjs.zzf(it.next(), zzdkk.zzgzu);
                break;
            } catch (zzdlg unused) {
            }
        }
        ...
        return this.zzfpw.zzu(zzdor.ADAPTER_LOAD_AD_SYN).zza((zzdoe) new zzcvh(this, zzdkw, zzdkk, zzcqv), this.zzgnn).zzw(zzdor.ADAPTER_LOAD_AD_ACK).zze(zzbbn).zzw(zzdor.ADAPTER_WRAP_ADAPTER).zzb(new zzcvg(this, zzdkw, zzdkk, zzcqv)).zzaus();
    }
