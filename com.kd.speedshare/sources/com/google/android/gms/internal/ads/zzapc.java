...
public final class zzapc extends zzaow {
    ...
    public final void zza(String str, String str2, zzve zzve, IObjectWrapper iObjectWrapper, zzaol zzaol, zzamx zzamx, zzvh zzvh) throws RemoteException {
        ...
        zzvh zzvh2 = zzvh;
        try {
            zzapf zzapf = new zzapf(this, zzaol, zzamx);
            RtbAdapter rtbAdapter = this.zzdky;
            Bundle zzds = zzds(str2);
            Bundle zzd = zzd(zzve2);
            boolean zzc = zzc(zzve);
            Location location = zzve2.zznb;
            int i = zzve2.zzadg;
            int i2 = zzve2.zzadh;
            String zza = zza(str2, zzve);
            AdSize zza2 = zzb.zza(zzvh2.width, zzvh2.height, zzvh2.zzacv);
            String str3 = this.zzdla;
            MediationBannerAdConfiguration mediationBannerAdConfiguration = r5;
            MediationBannerAdConfiguration mediationBannerAdConfiguration2 = new MediationBannerAdConfiguration((Context) ObjectWrapper.unwrap(iObjectWrapper), str, zzds, zzd, zzc, location, i, i2, zza, zza2, str3);
            rtbAdapter.loadBannerAd(mediationBannerAdConfiguration, zzapf);
        } catch (Throwable th) {
    ...
    public final void zza(String str, String str2, zzve zzve, IObjectWrapper iObjectWrapper, zzaom zzaom, zzamx zzamx) throws RemoteException {
        zzve zzve2 = zzve;
        try {
            this.zzdky.loadInterstitialAd(new MediationInterstitialAdConfiguration((Context) ObjectWrapper.unwrap(iObjectWrapper), str, zzds(str2), zzd(zzve2), zzc(zzve), zzve2.zznb, zzve2.zzadg, zzve2.zzadh, zza(str2, zzve), this.zzdla), new zzape(this, zzaom, zzamx));
        } catch (Throwable th) {
    ...
    public final void zza(String str, String str2, zzve zzve, IObjectWrapper iObjectWrapper, zzaos zzaos, zzamx zzamx) throws RemoteException {
        zzve zzve2 = zzve;
        try {
            this.zzdky.loadRewardedAd(new MediationRewardedAdConfiguration((Context) ObjectWrapper.unwrap(iObjectWrapper), str, zzds(str2), zzd(zzve2), zzc(zzve), zzve2.zznb, zzve2.zzadg, zzve2.zzadh, zza(str2, zzve), this.zzdla), zza(zzaos, zzamx));
        } catch (Throwable th) {
    ...
    public final void zzb(String str, String str2, zzve zzve, IObjectWrapper iObjectWrapper, zzaos zzaos, zzamx zzamx) throws RemoteException {
        zzve zzve2 = zzve;
        try {
            this.zzdky.loadRewardedInterstitialAd(new MediationRewardedAdConfiguration((Context) ObjectWrapper.unwrap(iObjectWrapper), str, zzds(str2), zzd(zzve2), zzc(zzve), zzve2.zznb, zzve2.zzadg, zzve2.zzadh, zza(str2, zzve), this.zzdla), zza(zzaos, zzamx));
        } catch (Throwable th) {
    ...
    public final void zza(String str, String str2, zzve zzve, IObjectWrapper iObjectWrapper, zzaor zzaor, zzamx zzamx) throws RemoteException {
        zzve zzve2 = zzve;
        try {
            this.zzdky.loadNativeAd(new MediationNativeAdConfiguration((Context) ObjectWrapper.unwrap(iObjectWrapper), str, zzds(str2), zzd(zzve2), zzc(zzve), zzve2.zznb, zzve2.zzadg, zzve2.zzadh, zza(str2, zzve), this.zzdla), new zzaph(this, zzaor, zzamx));
        } catch (Throwable th) {
            zzbba.zzc("Adapter failed to render rewarded ad.", th);
            throw new RemoteException();
        }
