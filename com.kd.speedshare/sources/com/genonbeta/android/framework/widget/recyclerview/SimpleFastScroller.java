...
public class SimpleFastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    private final Runnable mHideRunnable = new Runnable() {
        public void run() {
            SimpleFastScroller.this.hide(500);
        }
    };
    ...
    private final RecyclerView.OnScrollListener mOnScrollListener = new RecyclerView.OnScrollListener() {
        public void onScrolled(RecyclerView recyclerView, int i, int i2) {
            SimpleFastScroller.this.updateScrollPosition(recyclerView.computeHorizontalScrollOffset(), recyclerView.computeVerticalScrollOffset());
        }
    };
    ...
    public SimpleFastScroller(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i, int i2, int i3) {
    ...
    private class AnimatorListener extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            } else if (((Float) SimpleFastScroller.this.mShowHideAnimator.getAnimatedValue()).floatValue() == 0.0f) {
                SimpleFastScroller.this.mAnimationState = 0;
                SimpleFastScroller.this.setState(0);
            } else {
                SimpleFastScroller.this.mAnimationState = 2;
                SimpleFastScroller.this.requestRedraw();
            }
        }
    ...
    private class AnimatorUpdater implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            SimpleFastScroller.this.mVerticalThumbDrawable.setAlpha(floatValue);
            SimpleFastScroller.this.mVerticalTrackDrawable.setAlpha(floatValue);
            SimpleFastScroller.this.requestRedraw();
        }
    }
}
