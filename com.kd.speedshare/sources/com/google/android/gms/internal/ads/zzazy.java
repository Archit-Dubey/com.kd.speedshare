...
public final class zzazy {
    ...
    public static JSONObject zzc(JsonReader jsonReader) throws IllegalStateException, IOException, JSONException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (JsonToken.BEGIN_ARRAY.equals(peek)) {
                jSONObject.put(nextName, (Object) zzd(jsonReader));
            } else if (JsonToken.BEGIN_OBJECT.equals(peek)) {
                jSONObject.put(nextName, (Object) zzc(jsonReader));
    ...
    public static JSONArray zzd(JsonReader jsonReader) throws IllegalStateException, IOException, JSONException {
        ...
        while (jsonReader.hasNext()) {
            JsonToken peek = jsonReader.peek();
            if (JsonToken.BEGIN_ARRAY.equals(peek)) {
                jSONArray.put((Object) zzd(jsonReader));
            } else if (JsonToken.BEGIN_OBJECT.equals(peek)) {
                jSONArray.put((Object) zzc(jsonReader));
            } else if (JsonToken.BOOLEAN.equals(peek)) {
                ...
                if (opt instanceof Boolean) {
                    ...
                    if (!(jSONArray == null || jSONArray.length() == 0)) {
                        ...
                        if (obj == null) {
                            ...
                            zzaxv.zzfd(String.format("JSONArray with unsupported type %s for key:%s", new Object[]{obj.getClass().getCanonicalName(), next}));
                        }
                    }
