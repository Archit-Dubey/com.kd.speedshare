...
final /* synthetic */ class zzcex implements Callable {
    ...
    public final Object call() {
        ...
        if (zzdla.zzhba.contains(Integer.toString(zzcck.zzalg()))) {
            ...
            zzcck.zzn("body", jSONObject.optString("body", (String) null));
            zzcck.zzn("call_to_action", jSONObject.optString("call_to_action", (String) null));
            zzcck.zzn("store", jSONObject.optString("store", (String) null));
            zzcck.zzn("price", jSONObject.optString("price", (String) null));
            zzcck.zzn("advertiser", jSONObject.optString("advertiser", (String) null));
            return zzcck;
        }
        int i = zzdls.zzhbq;
