...
final class zzli {
            ...
            if (i2 != zzayf) {
                if (i2 != zzayg) {
                    if (i2 != zzaym) {
                        if (i2 != zzayn) {
                            if (i2 == zzayi) {
                                zzmk zza = zza(readInt, "TDRC", zzpi);
                                zzpi.zzbk(position);
                                return zza;
                            } else if (i2 == zzayj) {
                                zzmk zza2 = zza(readInt, "TPE1", zzpi);
                                zzpi.zzbk(position);
                                return zza2;
                            } else if (i2 == zzayk) {
                                zzmk zza3 = zza(readInt, "TSSE", zzpi);
                                zzpi.zzbk(position);
                                return zza3;
                            } else if (i2 == zzayl) {
                                zzmk zza4 = zza(readInt, "TALB", zzpi);
                                zzpi.zzbk(position);
                                return zza4;
                            } else if (i2 == zzayo) {
                                zzmk zza5 = zza(readInt, "USLT", zzpi);
                                zzpi.zzbk(position);
                                return zza5;
                            } else if (i2 == zzayp) {
                                zzmk zza6 = zza(readInt, "TCON", zzpi);
                                zzpi.zzbk(position);
                                return zza6;
                            } else if (i2 == zzays) {
                                zzmk zza7 = zza(readInt, "TIT1", zzpi);
                                zzpi.zzbk(position);
                                return zza7;
                            }
                        }
                    }
                    zzmk zza8 = zza(readInt, "TCOM", zzpi);
                    zzpi.zzbk(position);
                    return zza8;
                }
            }
            zzmk zza9 = zza(readInt, "TIT2", zzpi);
            zzpi.zzbk(position);
            return zza9;
        }
        try {
    ...
    private static zzmk zza(int i, String str, zzpi zzpi) {
        ...
        if (zzpi.readInt() == zzkt.zzavu) {
            zzpi.zzbl(8);
            return new zzmk(str, (String) null, zzpi.zzbm(readInt - 16));
        }
    ...
    private static zzml zza(int i, String str, zzpi zzpi, boolean z, boolean z2) {
        ...
        if (zze < 0) {
            ...
            return new zzmk(str, (String) null, Integer.toString(zze));
        } else {
