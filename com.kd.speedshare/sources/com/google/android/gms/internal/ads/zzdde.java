...
public final class zzdde implements zzdec<zzddb> {
    ...
    public final /* synthetic */ zzdvf zza(String str, List list, Bundle bundle) throws Exception {
        ...
        if (zzgo != null) {
            ...
            zzgo.zza(ObjectWrapper.wrap(this.zzvr), this.zzgqz, bundle2, (Bundle) list.get(0), this.zzfpv.zzboz, (zzaoy) new zzcwp(str, zzgo, zzbbn));
            return zzbbn;
        }
        throw null;
    }
    ...
    public final /* synthetic */ zzdvf zzaqy() {
        ...
        for (Map.Entry next : zzs.entrySet()) {
            ...
            arrayList.add(zzduo.zzg(zzdux.zza(new zzddg(this, str, (List) next.getValue(), this.zzfpv.zzhay.zzcgz != null ? this.zzfpv.zzhay.zzcgz.getBundle(str) : null), this.zzgad)).zza(((Long) zzwg.zzpw().zzd(zzaav.zzcpo)).longValue(), TimeUnit.MILLISECONDS, this.zzfkm).zza(Throwable.class, new zzddf(str), (Executor) this.zzgad));
        }
