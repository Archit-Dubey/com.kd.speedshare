...
public final class zzyu {
    ...
    public zzyu(Context context) {
        this(context, zzvf.zzchh, (PublisherInterstitialAd) null);
    }
    ...
    public final void zza(zzyq zzyq) {
        try {
            if (this.zzbul == null) {
                ...
                this.zzbul = zzww;
                if (this.zzcgq != null) {
                    zzww.zza((zzwj) new zzva(this.zzcgq));
                }
                if (this.zzcgl != null) {
                    this.zzbul.zza((zzwi) new zzut(this.zzcgl));
                }
                if (this.zzcgr != null) {
                    this.zzbul.zza((zzwz) new zzvb(this.zzcgr));
                }
                if (this.zzbnt != null) {
                    this.zzbul.zza((zzxe) new zzvl(this.zzbnt));
                }
                if (this.zzcjm != null) {
                    this.zzbul.zza((zzabo) new zzabt(this.zzcjm));
                }
                if (this.zzcjv != null) {
                    this.zzbul.zza((zzatq) new zzatt(this.zzcjv));
                }
                this.zzbul.zza((zzyc) new zzzv(this.zzcjp));
    ...
    public final void setAdListener(AdListener adListener) {
        try {
            ...
            if (this.zzbul != null) {
                this.zzbul.zza((zzwj) adListener != null ? new zzva(adListener) : null);
            }
        } catch (RemoteException e) {
            zzbba.zze("#008 Must be called on the main UI thread.", e);
        }
    ...
    public final void zza(zzuu zzuu) {
        try {
            this.zzcgl = zzuu;
            if (this.zzbul != null) {
                this.zzbul.zza((zzwi) zzuu != null ? new zzut(zzuu) : null);
            }
        } catch (RemoteException e) {
            zzbba.zze("#008 Must be called on the main UI thread.", e);
        }
    ...
    public final void setAdMetadataListener(AdMetadataListener adMetadataListener) {
        try {
            ...
            if (this.zzbul != null) {
                this.zzbul.zza((zzwz) adMetadataListener != null ? new zzvb(adMetadataListener) : null);
            }
        } catch (RemoteException e) {
            zzbba.zze("#008 Must be called on the main UI thread.", e);
        }
    ...
    public final void setAppEventListener(AppEventListener appEventListener) {
        try {
            ...
            if (this.zzbul != null) {
                this.zzbul.zza((zzxe) appEventListener != null ? new zzvl(appEventListener) : null);
            }
        } catch (RemoteException e) {
            zzbba.zze("#008 Must be called on the main UI thread.", e);
        }
    ...
    public final void setOnCustomRenderedAdLoadedListener(OnCustomRenderedAdLoadedListener onCustomRenderedAdLoadedListener) {
        try {
            ...
            if (this.zzbul != null) {
                this.zzbul.zza((zzabo) onCustomRenderedAdLoadedListener != null ? new zzabt(onCustomRenderedAdLoadedListener) : null);
            }
        } catch (RemoteException e) {
            zzbba.zze("#008 Must be called on the main UI thread.", e);
        }
    ...
    public final void setRewardedVideoAdListener(RewardedVideoAdListener rewardedVideoAdListener) {
        try {
            ...
            if (this.zzbul != null) {
                this.zzbul.zza((zzatq) rewardedVideoAdListener != null ? new zzatt(rewardedVideoAdListener) : null);
            }
        } catch (RemoteException e) {
            zzbba.zze("#008 Must be called on the main UI thread.", e);
        }
    ...
    public final void setOnPaidEventListener(OnPaidEventListener onPaidEventListener) {
        try {
            ...
            if (this.zzbul != null) {
                this.zzbul.zza((zzyc) new zzzv(onPaidEventListener));
            }
        } catch (RemoteException e) {
            zzbba.zze("#008 Must be called on the main UI thread.", e);
        }
