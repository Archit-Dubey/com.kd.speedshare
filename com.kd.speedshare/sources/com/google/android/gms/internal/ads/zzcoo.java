...
public final class zzcoo {
    ...
    private final <RetT> zzdvf<RetT> zza(zzasm zzasm, zzcoz<InputStream> zzcoz, zzcoz<InputStream> zzcoz2, zzduh<InputStream, RetT> zzduh) {
        ...
        return zzduo.zzg(zzdvf).zzb(zzduh, this.zzgad).zza(zzcop.class, new zzcoq(this, zzcoz2, zzasm, zzduh), (Executor) this.zzgad);
    }
    ...
    public final zzdvf<zzasm> zzl(zzasm zzasm) {
        ...
        zzcof.getClass();
        return zza(zzasm, (zzcoz<InputStream>) zzcos.zza(zzcof), (zzcoz<InputStream>) new zzcov(this), zzcot);
    }
    ...
    public final zzdvf<Void> zzm(zzasm zzasm) {
        ...
        return zza(zzasm, (zzcoz<InputStream>) new zzcox(this), (zzcoz<InputStream>) new zzcow(this), zzcou.zzboi);
    }
    ...
    public final /* synthetic */ zzdvf zza(zzcoz zzcoz, zzasm zzasm, zzduh zzduh, zzcop zzcop) throws Exception {
        return zzdux.zzb(zzcoz.zzq(zzasm), zzduh, (Executor) this.zzgad);
    }
}
