...
public final class zzpl {
    ...
    public final int zzbn(int i) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            if (i5 != 0) {
                byte[] bArr = this.data;
                b2 = ((bArr[i4] & 255) >>> (8 - i5)) | ((bArr[this.zzbjz] & 255) << i5);
            } else {
        ...
        if (i > 0) {
            ...
            if (i6 > 8) {
                ...
                b = (b4 & (((255 & bArr2[i7]) >> (16 - i6)) | ((bArr2[this.zzbjz] & 255) << (i6 - 8)))) | b3;
                this.zzbjz = i7;
            } else {
    ...
    private final void zzjg() {
        ...
        L_0x0017:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzpl.zzjg():void");
    }
}
