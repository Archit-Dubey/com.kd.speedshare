...
final class zzeen {
    static int zza(byte[] bArr, int i, zzeem zzeem) {
        ...
        byte b = bArr[i];
        if (b < 0) {
            return zza((int) b, bArr, i2, zzeem);
        }
        zzeem.zzhzo = b;
        return i2;
    }
    ...
    static int zza(com.google.android.gms.internal.ads.zzeih r6, byte[] r7, int r8, int r9, com.google.android.gms.internal.ads.zzeem r10) throws java.io.IOException {
        /*
            int r0 = r8 + 1
            byte r8 = r7[r8]
            if (r8 >= 0) goto L_0x000c
            int r0 = zza((int) r8, (byte[]) r7, (int) r0, (com.google.android.gms.internal.ads.zzeem) r10)
            int r8 = r10.zzhzo
        L_0x000c:
            r3 = r0
            ...
            return r8
        L_0x0025:
            com.google.android.gms.internal.ads.zzegl r6 = com.google.android.gms.internal.ads.zzegl.zzbfu()
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzeen.zza(com.google.android.gms.internal.ads.zzeih, byte[], int, int, com.google.android.gms.internal.ads.zzeem):int");
    }
    ...
    static int zza(zzeih<?> zzeih, int i, byte[] bArr, int i2, int i3, zzegm<?> zzegm, zzeem zzeem) throws IOException {
        int zza = zza((zzeih) zzeih, bArr, i2, i3, zzeem);
        ...
        while (zza < i3) {
            ...
            zza = zza((zzeih) zzeih, bArr, zza2, i3, zzeem);
            zzegm.add(zzeem.zzhzq);
        }
        return zza;
    }
