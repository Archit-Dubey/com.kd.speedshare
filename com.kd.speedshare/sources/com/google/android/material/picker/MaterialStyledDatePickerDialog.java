...
public class MaterialStyledDatePickerDialog extends DatePickerDialog {
    ...
    public MaterialStyledDatePickerDialog(Context context, int i, DatePickerDialog.OnDateSetListener onDateSetListener, int i2, int i3, int i4) {
        ...
        int i5 = MaterialAttributes.resolveAttributeOrThrow(getContext(), R.attr.colorSurface, getClass().getCanonicalName()).data;
    ...
    public void onCreate(Bundle bundle) {
        ...
        getWindow().getDecorView().setOnTouchListener(new InsetDialogOnTouchListener((AlertDialog) this, this.backgroundInsets));
    }
}
