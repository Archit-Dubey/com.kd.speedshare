...
public final class zzcao implements zzo, zzbua {
    ...
    private final zzty.zza.C0015zza zzfuc;
    private final Context zzvr;

    public zzcao(Context context, zzbfn zzbfn, zzdkk zzdkk, zzbbd zzbbd, zzty.zza.C0015zza zza) {
        this.zzvr = context;
        this.zzdfp = zzbfn;
        this.zzfol = zzdkk;
        this.zzboy = zzbbd;
    ...
    public final void onAdLoaded() {
        if ((this.zzfuc == zzty.zza.C0015zza.REWARD_BASED_VIDEO_AD || this.zzfuc == zzty.zza.C0015zza.INTERSTITIAL) && this.zzfol.zzdse && this.zzdfp != null && zzq.zzll().zzp(this.zzvr)) {
