...
final class zzox<T extends zzow> extends Handler implements Runnable {
    ...
    public final void zzl(boolean z) {
        ...
        if (z) {
            ...
            this.zzbjd.zza(this.zzbjc, elapsedRealtime, elapsedRealtime - this.zzbjf, true);
        }
    }
    ...
    public final void handleMessage(Message message) {
        ...
        if (!this.zzafn) {
            if (message.what == 0) {
                ...
                if (this.zzbjc.zzhw()) {
                    this.zzbjd.zza(this.zzbjc, elapsedRealtime, j, false);
                    return;
                }
                int i2 = message.what;
                if (i2 == 1) {
    ...
    private final void finish() {
        zzox unused = this.zzbjj.zzbja = null;
    }
}
