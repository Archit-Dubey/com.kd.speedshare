...
public class zzyt {
                ...
                if (context != null) {
                    try {
                        ...
                        if (onInitializationCompleteListener != null) {
                            this.zzcjr.zza((zzaij) new zza(this, onInitializationCompleteListener, (zzyx) null));
                        }
                        this.zzcjr.zza((zzamr) new zzamo());
    ...
    public static InitializationStatus zzd(List<zzaic> list) {
        ...
        for (zzaic next : list) {
            hashMap.put(next.zzder, new zzaik(next.zzdes ? AdapterStatus.State.READY : AdapterStatus.State.NOT_READY, next.description, next.zzdet));
        }
