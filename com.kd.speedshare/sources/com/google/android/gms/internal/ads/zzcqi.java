...
public final class zzcqi {
    ...
    public final byte[] zza(boolean z, ArrayList<zzty.zzc.zza> arrayList, zzty.zzm zzm, zzty.zzo.zzc zzc) {
        boolean z2 = true;
        zzty.zzo.zza.C0018zza zzeu = zzty.zzo.zza.zzol().zzf((Iterable<? extends zzty.zzc.zza>) arrayList).zzh(zzbk(zzq.zzky().zzb(this.zzvr.getContentResolver()) != 0)).zzi(zzq.zzky().zza(this.zzvr, this.zzgjq)).zzev(this.zzggx.zzapj()).zzew(this.zzggx.zzapl()).zzcn(this.zzggx.getResponseCode()).zzb(zzc).zzb(zzm).zzj(this.zzgjs).zzf(zzbk(z)).zzeu(zzq.zzld().currentTimeMillis());
