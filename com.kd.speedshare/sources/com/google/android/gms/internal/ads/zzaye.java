...
public final class zzaye {
    ...
    public String zzbil;
    private AtomicReference<Pattern> zzdzu = new AtomicReference<>((Object) null);
    private AtomicReference<Pattern> zzdzv = new AtomicReference<>((Object) null);
    /* access modifiers changed from: private */
    ...
    public final void zza(Context context, String str, boolean z, HttpURLConnection httpURLConnection) {
        ...
        httpURLConnection.setRequestProperty(HttpRequest.HEADER_USER_AGENT, zzs(context, str));
    ...
    public final boolean zzap(Context context) {
        ...
        context.getApplicationContext().registerReceiver(new zzayk(this, (zzayg) null), intentFilter);
        this.zzdzy = true;
        return true;
    }
    ...
    public final boolean zzaq(Context context) {
        ...
        context.getApplicationContext().registerReceiver(new zzayh(this, (zzayg) null), intentFilter);
        this.zzdzz = true;
        return true;
    }
    ...
    public final java.lang.String zzs(android.content.Context r5, java.lang.String r6) {
        /*
            r4 = this;
            java.lang.Object r0 = r4.zzdzx
            monitor-enter(r0)
            java.lang.String r1 = r4.zzbil     // Catch:{ all -> 0x00cd }
            if (r1 == 0) goto L_0x000b
            java.lang.String r5 = r4.zzbil     // Catch:{ all -> 0x00cd }
            monitor-exit(r0)     // Catch:{ all -> 0x00cd }
            return r5
        L_0x000b:
            if (r6 != 0) goto L_0x0013
            java.lang.String r5 = zzxi()     // Catch:{ all -> 0x00cd }
            monitor-exit(r0)     // Catch:{ all -> 0x00cd }
            return r5
        L_0x0013:
            ...
            r4.zzbil = r1     // Catch:{ Exception -> 0x001d }
        L_0x001d:
            java.lang.String r1 = r4.zzbil     // Catch:{ all -> 0x00cd }
            boolean r1 = android.text.TextUtils.isEmpty(r1)     // Catch:{ all -> 0x00cd }
            if (r1 == 0) goto L_0x006b
            com.google.android.gms.internal.ads.zzwg.zzps()     // Catch:{ all -> 0x00cd }
            boolean r1 = com.google.android.gms.internal.ads.zzbaq.zzyi()     // Catch:{ all -> 0x00cd }
            if (r1 != 0) goto L_0x0065
            r1 = 0
            r4.zzbil = r1     // Catch:{ all -> 0x00cd }
            com.google.android.gms.internal.ads.zzdrr r1 = zzdzw     // Catch:{ all -> 0x00cd }
            com.google.android.gms.internal.ads.zzayf r2 = new com.google.android.gms.internal.ads.zzayf     // Catch:{ all -> 0x00cd }
            r2.<init>(r4, r5)     // Catch:{ all -> 0x00cd }
            r1.post(r2)     // Catch:{ all -> 0x00cd }
        L_0x003b:
            java.lang.String r1 = r4.zzbil     // Catch:{ all -> 0x00cd }
            if (r1 != 0) goto L_0x006b
            java.lang.Object r1 = r4.zzdzx     // Catch:{ InterruptedException -> 0x0045 }
            r1.wait()     // Catch:{ InterruptedException -> 0x0045 }
            goto L_0x003b
        L_0x0045:
            java.lang.String r1 = zzxi()     // Catch:{ all -> 0x00cd }
            r4.zzbil = r1     // Catch:{ all -> 0x00cd }
        ...
        L_0x0061:
            com.google.android.gms.internal.ads.zzaxv.zzfd(r1)     // Catch:{ all -> 0x00cd }
            goto L_0x003b
        L_0x0065:
        ...
        L_0x006b:
            ...
            java.lang.String r5 = r4.zzbil     // Catch:{ Exception -> 0x00b3 }
            ...
            r4.zzbil = r5     // Catch:{ Exception -> 0x00b3 }
            goto L_0x00bd
        L_0x00b3:
            r5 = move-exception
        ...
        L_0x00d1:
            goto L_0x00d0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaye.zzs(android.content.Context, java.lang.String):java.lang.String");
    }
    ...
    private final void zza(JSONArray jSONArray, Object obj) throws JSONException {
        if (obj instanceof Bundle) {
            jSONArray.put((Object) zzd((Bundle) obj));
        } else if (obj instanceof Map) {
            jSONArray.put((Object) zzj((Map<String, ?>) (Map) obj));
        } else if (obj instanceof Collection) {
            jSONArray.put((Object) zza((Collection<?>) (Collection) obj));
    ...
    private final void zza(JSONObject jSONObject, String str, Object obj) throws JSONException {
        if (obj instanceof Bundle) {
            jSONObject.put(str, (Object) zzd((Bundle) obj));
        } else if (obj instanceof Map) {
            jSONObject.put(str, (Object) zzj((Map<String, ?>) (Map) obj));
        } else if (obj instanceof Collection) {
            if (str == null) {
                str = "null";
            }
            jSONObject.put(str, (Object) zza((Collection<?>) (Collection) obj));
        } else if (obj instanceof Object[]) {
            jSONObject.put(str, (Object) zza((Collection<?>) Arrays.asList((Object[]) obj)));
        } else {
    ...
    public final zzdvf<Map<String, String>> zzi(Uri uri) {
        return zzdux.zzb(zzdux.zzaf(null), new zzayd(this, uri), (Executor) zzbbf.zzedh);
    }
    ...
    public final int[] zze(Activity activity) {
        ...
        return new int[]{zzwg.zzps().zzb((Context) activity, zzd[0]), zzwg.zzps().zzb((Context) activity, zzd[1])};
    }
    ...
    public final int[] zzf(android.app.Activity r7) {
        ...
        L_0x0025:
            int[] r0 = new int[r1]
            com.google.android.gms.internal.ads.zzbaq r1 = com.google.android.gms.internal.ads.zzwg.zzps()
            r5 = r4[r3]
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaye.zzf(android.app.Activity):int[]");
    }
    ...
    public final boolean zza(android.view.View r4, android.os.PowerManager r5, android.app.KeyguardManager r6) {
        ...
        L_0x0036:
            ...
            com.google.android.gms.internal.ads.zzaag<java.lang.Boolean> r5 = com.google.android.gms.internal.ads.zzaav.zzcph
        ...
        L_0x0063:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaye.zza(android.view.View, android.os.PowerManager, android.app.KeyguardManager):boolean");
    }
    ...
    public static WebResourceResponse zzd(Context context, String str, String str2) {
        try {
            HashMap hashMap = new HashMap();
            hashMap.put(HttpRequest.HEADER_USER_AGENT, zzq.zzkw().zzs(context, str));
            hashMap.put(HttpRequest.HEADER_CACHE_CONTROL, "max-stale=3600");
            String str3 = (String) new zzazq(context).zzc(str2, hashMap).get(60, TimeUnit.SECONDS);
            if (str3 != null) {
    ...
    public static boolean zzeq(String str) {
        ...
        String str3 = (String) zzwg.zzpw().zzd(zzaav.zzcth);
        if (str3.isEmpty()) {
            return true;
        }
