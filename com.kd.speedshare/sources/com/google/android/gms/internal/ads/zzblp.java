...
public final class zzblp {
    ...
    public final void zzd(zzbfn zzbfn) {
        zzbfn.zza("/updateActiveView", (zzahc<? super zzbfn>) this.zzflg);
        zzbfn.zza("/untrackActiveViewUnit", (zzahc<? super zzbfn>) this.zzflh);
    }

    public final void zze(zzbfn zzbfn) {
        zzbfn.zzb("/updateActiveView", (zzahc<? super zzbfn>) this.zzflg);
        zzbfn.zzb("/untrackActiveViewUnit", (zzahc<? super zzbfn>) this.zzflh);
    }
