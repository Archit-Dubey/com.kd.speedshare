...
final class zzeij {
    ...
    private static zzeiz<?, ?> zzbv(boolean z) {
        try {
            ...
            return (zzeiz) zzbhi.getConstructor(new Class[]{Boolean.TYPE}).newInstance(new Object[]{Boolean.valueOf(z)});
    ...
    static <T> void zza(zzehi zzehi, T t, T t2, long j) {
        zzejf.zza((Object) t, j, zzehi.zzf(zzejf.zzp(t, j), zzejf.zzp(t2, j)));
    }
