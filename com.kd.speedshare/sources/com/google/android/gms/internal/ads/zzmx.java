...
public final class zzmx implements zzna, zznb {
    ...
    public final void zza(zzhe zzhe, boolean z, zzna zzna) {
        ...
        this.zzaev = zznp;
        zzna.zzb(zznp, (Object) null);
    }

    public final zzmz zza(int i, zzoi zzoi) {
        zzpb.checkArgument(i == 0);
        return new zzmp(this.uri, this.zzbem.zzio(), this.zzben.zzgq(), this.zzbde, this.zzaek, this.zzbdf, this, zzoi, (String) null, this.zzbeo);
    }
    ...
    public final void zzb(zzia zzia, Object obj) {
        ...
        if (!this.zzbep || z) {
            this.zzaev = zzia;
            this.zzbep = z;
            this.zzbdg.zzb(zzia, (Object) null);
        }
    }
}
