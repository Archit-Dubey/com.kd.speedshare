...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    ...
    private static Context createMaterialAlertDialogThemedContext(Context context) {
        ...
        context.getTheme().resolveAttribute(MATERIAL_ALERT_DIALOG_THEME_OVERLAY, typedValue, true);
        return new ContextThemeWrapper(ThemeEnforcement.createThemedContext(context, (AttributeSet) null, DEF_STYLE_ATTR, DEF_STYLE_RES), typedValue.resourceId);
    }
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        super(createMaterialAlertDialogThemedContext(context), i);
        Context context2 = getContext();
        Resources.Theme theme = context2.getTheme();
        this.backgroundInsets = MaterialDialogs.getDialogBackgroundInsets(context2, DEF_STYLE_ATTR, DEF_STYLE_RES);
        int i2 = MaterialAttributes.resolveAttributeOrThrow(context2, R.attr.colorSurface, getClass().getCanonicalName()).data;
