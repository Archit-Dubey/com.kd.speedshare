...
public final class zzcvk implements zzcqt<zzbnc> {
    ...
    public final zzdvf<zzbnc> zzb(zzdkw zzdkw, zzdkk zzdkk) {
        zzbnf zza = this.zzgkn.zza(new zzbpr(zzdkw, zzdkk, (String) null), (zzbnj) new zzcvp(this, new View(this.zzgns), (zzbfn) null, zzcvn.zzgnx, zzdkk.zzgzt.get(0)));
        return this.zzfpw.zzu(zzdor.CUSTOM_RENDER_SYN).zza((zzdoe) new zzcvm(this, new zzabl(zza.zzafp(), zzdkk.zzgzr.zzdof, zzdkk.zzgzr.zzdoh)), this.zzgnn).zzw(zzdor.CUSTOM_RENDER_ACK).zze(zzdux.zzaf(zza.zzafn())).zzaus();
    }
