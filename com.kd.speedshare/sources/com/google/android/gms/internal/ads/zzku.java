...
final class zzku {
    ...
    private static final int zzawg = zzpo.zzbk(AccessDatabase.FIELD_CLIPBOARD_TEXT);
    ...
    public static com.google.android.gms.internal.ads.zzlp zza(com.google.android.gms.internal.ads.zzks r49, com.google.android.gms.internal.ads.zzkv r50, long r51, com.google.android.gms.internal.ads.zzjl r53, boolean r54) throws com.google.android.gms.internal.ads.zzht {
        ...
        L_0x011d:
            ...
            r30 = r32
            long r2 = com.google.android.gms.internal.ads.zzpo.zza((long) r26, (long) r28, (long) r30)
            r26 = r2
        L_0x0128:
        ...
        L_0x0384:
            ...
            r6 = r39
            int r1 = zza((com.google.android.gms.internal.ads.zzpi) r12, (int) r10, (int) r14, (com.google.android.gms.internal.ads.zzkz) r11, (int) r6)
            r12.zzbk(r5)
            goto L_0x0398
        L_0x0396:
            r6 = r39
        ...
        L_0x05a2:
            ...
            int r1 = zza((com.google.android.gms.internal.ads.zzpi) r13, (int) r12, (int) r14, (com.google.android.gms.internal.ads.zzkz) r15, (int) r9)
            r13.zzbk(r3)
        L_0x05e6:
            r2 = 0
            r5 = 0
    ...
    public static zzlq zza(zzlp zzlp, zzks zzks, zzkb zzkb) throws zzht {
        ...
        zzks zzks2 = zzks;
        zzkb zzkb2 = zzkb;
        zzkv zzaq = zzks2.zzaq(zzkt.zzavf);
        if (zzaq != null) {
            zzkw = new zzky(zzaq);
        } else {
            zzkv zzaq2 = zzks2.zzaq(zzkt.zzavg);
            if (zzaq2 != null) {
                zzkw = new zzlb(zzaq2);
            } else {
        ...
        zzkv zzaq3 = zzks2.zzaq(zzkt.zzavh);
        if (zzaq3 == null) {
            zzaq3 = zzks2.zzaq(zzkt.zzavi);
            z = true;
        } else {
            z = false;
        }
        zzpi zzpi = zzaq3.zzawl;
        zzpi zzpi2 = zzks2.zzaq(zzkt.zzave).zzawl;
        zzpi zzpi3 = zzks2.zzaq(zzkt.zzavb).zzawl;
        zzkv zzaq4 = zzks2.zzaq(zzkt.zzavc);
        zzpi zzpi4 = null;
        zzpi zzpi5 = zzaq4 != null ? zzaq4.zzawl : null;
        zzkv zzaq5 = zzks2.zzaq(zzkt.zzavd);
        ...
        long j2 = 0;
        if (!(zzkw.zzgy() && "audio/raw".equals(zzlp3.zzahr.zzagw) && zziz == 0 && i == 0 && i2 == 0)) {
            ...
            i3 = zzgw;
            zzkw zzkw4 = zzkw;
            long[] jArr8 = new long[zzkx.length];
            int i32 = zzkx.length;
            int[] iArr5 = new int[i32];
            while (zzkx.zzgz()) {
                jArr8[zzkx.index] = zzkx.zzawn;
            ...
            zzlf zzlf = new zzlf(jArr9, iArr6, i39, jArr10, iArr7);
            jArr2 = zzlf.zzaon;
            iArr = zzlf.zzaom;
            i4 = zzlf.zzayb;
            jArr = zzlf.zzayc;
        ...
        if (zzlp2.zzbad.length == 1) {
            ...
            if (zzlp2.zzbad[0] == 0) {
                ...
                while (i45 < jArr.length) {
                    jArr[i45] = zzpo.zza(jArr[i45] - zzlp2.zzbae[c], 1000000, zzlp2.zzdg);
                    i45++;
                    c = 0;
                }
                return new zzlq(jArr2, iArr, i4, jArr, iArr2);
        ...
        int i47 = 0;
        int i48 = 0;
        while (i47 < zzlp2.zzbad.length) {
            long j8 = zzlp2.zzbae[i47];
            if (j8 != -1) {
                i6 = i4;
                long zza4 = zzpo.zza(zzlp2.zzbad[i47], zzlp2.zzdg, zzlp2.zzbaa);
        ...
        int i52 = 0;
        int i53 = 0;
        while (i52 < zzlp2.zzbad.length) {
            long j9 = zzlp2.zzbae[i52];
            long j10 = zzlp2.zzbad[i52];
            if (j9 != -1) {
                int[] iArr11 = iArr10;
                i5 = i52;
                long j11 = zzlp2.zzdg;
                ...
                int zzb4 = zzpo.zzb(jArr, zzpo.zza(j10, j11, zzlp2.zzbaa) + j9, z3, false);
                if (z5) {
                    int i54 = zzb4 - zzb3;
                    jArr3 = jArr14;
                    jArr4 = jArr15;
                ...
                while (zzb3 < zzb4) {
                    ...
                    int i56 = zzb4;
                    long j12 = j9;
                    jArr13[i53] = zzpo.zza(j2, 1000000, zzlp2.zzbaa) + zzpo.zza(jArr[zzb3] - j9, 1000000, zzlp2.zzdg);
                    if (z5 && iArr9[i53] > i55) {
                        i55 = iArr[zzb3];
                    }
                    i53++;
        ...
        if (z6) {
            return new zzlq(jArr16, iArr9, i51, jArr13, iArr13);
        }
