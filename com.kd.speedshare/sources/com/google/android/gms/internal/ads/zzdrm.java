...
public final class zzdrm {
        ...
        if (zzdrc.zzavv() != null) {
            ...
            try {
                if (this.zzhjx.zzb(zzdrc.zzavw())) {
                    ...
                    Class<?> loadClass = new DexClassLoader(zzdrc.zzavw().getAbsolutePath(), zzavx.getAbsolutePath(), (String) null, this.zzvr.getClassLoader()).loadClass("com.google.ccc.abuse.droidguard.DroidGuard");
                    zzhjw.put(zzdh, loadClass);
                    return loadClass;
                }
                throw new zzdrj(2026, "VM did not pass signature verification");
            } catch (GeneralSecurityException e) {
                throw new zzdrj(2026, (Throwable) e);
    ...
    private final Object zza(Class<?> cls, zzdrc zzdrc) throws zzdrj {
        try {
            return cls.getDeclaredConstructor(new Class[]{Context.class, String.class, byte[].class, Object.class, Bundle.class, Integer.TYPE}).newInstance(new Object[]{this.zzvr, "msa-r", zzdrc.zzavy(), null, new Bundle(), 2});
        } catch (Exception e) {
            throw new zzdrj(2004, (Throwable) e);
        }
    }
        ...
        try {
            ...
            if (zzdqz.zzavq()) {
                ...
                if (zzavr == 0) {
                    ...
                    this.zzvv.zzg(PathInterpolatorCompat.MAX_NUM_POINTS, System.currentTimeMillis() - currentTimeMillis);
                    return;
                }
            ...
            this.zzvv.zza(e2.zzavz(), System.currentTimeMillis() - currentTimeMillis, (Exception) e2);
        } catch (Exception e3) {
