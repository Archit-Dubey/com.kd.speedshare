...
public final class zzazo {
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add("name", this.name).add("minBound", Double.valueOf(this.zzebf)).add("maxBound", Double.valueOf(this.zzebe)).add("percent", Double.valueOf(this.zzebg)).add("count", Integer.valueOf(this.count)).toString();
    }
