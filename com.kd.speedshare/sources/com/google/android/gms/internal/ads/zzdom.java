...
public final class zzdom<O> {
    ...
    public final <O2> zzdom<O2> zza(zzduh<O, O2> zzduh) {
        return zza(zzduh, (Executor) this.zzhfp.zzgad);
    }
    ...
    public final <O2> zzdom<O2> zze(zzdvf<O2> zzdvf) {
        return zza(new zzdoo(zzdvf), (Executor) zzbbf.zzedm);
    }
    ...
    /* synthetic */ zzdom(zzdog zzdog, Object obj, String str, zzdvf zzdvf, List list, zzdvf zzdvf2, zzdof zzdof) {
