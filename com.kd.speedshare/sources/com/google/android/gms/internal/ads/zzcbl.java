...
public final class zzcbl implements zzela<zzbpc<zzbnc>> {
    ...
    public final /* synthetic */ Object get() {
        return (zzbpc) zzelg.zza(this.zzfvj.get().zzadl().zzc(this.zzfvk.get().zzaiz()).zzc(this.zzfvl.get()).zzb(this.zzfvm.get()).zza(new zzcvw((zzabo) null)).zza(new zzbou(this.zzfqt.get())).zzb(new zzbnb((ViewGroup) null)).zzafk().zzafr(), "Cannot return null from a non-@Nullable @Provides method");
    }
}
