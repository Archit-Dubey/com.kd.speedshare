...
final class zzdys implements zzecw {
    ...
    public final zzdwc zzn(byte[] bArr) throws GeneralSecurityException {
        if (bArr.length != this.zzhrq) {
            ...
            return (zzdwc) zzdwy.zza(this.zzhrp, (zzehl) (zzdzy) ((zzegb) ((zzdzy.zza) zzdzy.zzazf().zza(this.zzhrr)).zzw(zzeer.zzi(bArr, 0, this.zzhrq)).zzbfq()), zzdwc.class);
        } else if (this.zzhrp.equals(zzdxe.zzhqm)) {
            ...
            return (zzdwc) zzdwy.zza(this.zzhrp, (zzehl) (zzdzi) ((zzegb) zzb.zzb((zzeax) ((zzegb) ((zzeax.zza) zzeax.zzbaj().zza(this.zzhrs.zzayk())).zzad(zzeer.zzu(copyOfRange2)).zzbfq())).zzbfq()), zzdwc.class);
        } else {
