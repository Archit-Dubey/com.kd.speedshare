...
public final class zzahg<T extends zzbgq & zzbgp & zzbgt & zzbgy & zzbha> implements zzahc<T> {
    ...
    public final /* synthetic */ void zza(Object obj, Map map) {
        ...
        String zzc = zzawn.zzc((String) map.get("u"), zzbgq.getContext(), true);
        ...
        if (zzc2 != null && !zzc2.zzjy()) {
            ...
            ((zzbgt) zzbgq).zza(new zzd((String) map.get("i"), zzc, (String) map.get("m"), (String) map.get("p"), (String) map.get("c"), (String) map.get("f"), (String) map.get("e")));
        }
    }
}
