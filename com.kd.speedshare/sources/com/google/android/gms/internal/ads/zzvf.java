...
public final class zzvf {
    ...
    public static zzve zza(Context context, zzyq zzyq) {
        ...
        boolean isTestDevice = zzyq2.isTestDevice(context2);
        Location location = zzyq.getLocation();
        Bundle networkExtrasBundle = zzyq2.getNetworkExtrasBundle(AdMobAdapter.class);
        if (zzyq.zzqq() != null) {
