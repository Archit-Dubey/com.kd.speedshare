...
class FloatingActionButtonImpl {
    ...
    public void setBackgroundDrawable(ColorStateList colorStateList, PorterDuff.Mode mode, ColorStateList colorStateList2, int i) {
        ...
        MaterialShapeDrawable createShapeDrawable2 = createShapeDrawable();
        createShapeDrawable2.setTintList(RippleUtils.convertToRippleDrawableColor(colorStateList2));
        this.rippleDrawable = createShapeDrawable2;
        LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{(Drawable) Preconditions.checkNotNull(this.shapeDrawable), createShapeDrawable2});
        this.contentBackground = layerDrawable;
        this.shadowViewDelegate.setBackgroundDrawable(layerDrawable);
    }
