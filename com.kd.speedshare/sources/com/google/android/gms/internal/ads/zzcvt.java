...
public final class zzcvt<AdT> implements zzcqt<AdT> {
    ...
    public final zzdvf<AdT> zzb(zzdkw zzdkw, zzdkk zzdkk) {
        ...
        return this.zzfpw.zzu(zzdor.CUSTOM_RENDER_SYN).zza((zzdoe) new zzcvs(this, new zzabl(zzcwb, zzdkk.zzgzr.zzdof, zzdkk.zzgzr.zzdoh)), this.zzgnn).zzw(zzdor.CUSTOM_RENDER_ACK).zze(zzbbn).zzaus();
    }
