...
public final class zzcbk implements zzccs {
    ...
    public final void zza(View view, View view2, Map<String, WeakReference<View>> map, Map<String, WeakReference<View>> map2, boolean z) {
        ...
        zza(view, zza2, zza, zzt, zzb, zzb2, zzbae.zza(zzb2, this.zzvr, this.zzfvf, this.zzfve), (JSONObject) null, z, false);
    }
    ...
    public final void zza(View view, Map<String, WeakReference<View>> map, Map<String, WeakReference<View>> map2, boolean z) {
        ...
        if (!this.zzfvd) {
            ...
            zza(view, zza2, zza, zzt, zzb, zzb2, zzbae.zza(zzb2, this.zzvr, this.zzfvf, this.zzfve), (JSONObject) null, z, true);
        }
    }
    ...
    private final void zza(View view, JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, JSONObject jSONObject6, boolean z, boolean z2) {
        ...
        try {
            ...
            jSONObject7.put("ad", (Object) this.zzfus);
            ...
            jSONObject8.put("click_signals", (Object) zzx(view));
    ...
    public final void zza(View view, Map<String, WeakReference<View>> map, Map<String, WeakReference<View>> map2) {
        zza(zzbae.zza(this.zzvr, view), zzbae.zza(this.zzvr, map, map2, view), zzbae.zzt(view), zzbae.zzb(this.zzvr, view), zzy(view), (JSONObject) null, zzbae.zza(this.zzfol));
    }
    ...
    public final void zzakx() {
        ...
        try {
            ...
            jSONObject.put("ad", (Object) this.zzfus);
    ...
    public final boolean zzi(Bundle bundle) {
        ...
        return zza((JSONObject) null, (JSONObject) null, (JSONObject) null, (JSONObject) null, (String) null, zzq.zzkw().zza(bundle, (JSONObject) null), false);
    }
    ...
    private final boolean zza(JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, boolean z) {
        ...
        try {
            ...
            jSONObject6.put("ad", (Object) this.zzfus);
            ...
            jSONObject6.put("screen", (Object) zzbae.zzbm(this.zzvr));
            this.zzfut.zza("/logScionEvent", (zzahc<Object>) new zzcbm(this));
            this.zzfut.zza("/nativeImpression", (zzahc<Object>) new zzcbp(this));
