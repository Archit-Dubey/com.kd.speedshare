...
public final class zzdok {
    ...
    public final <O> zzdom<O> zze(zzdvf<O> zzdvf) {
        return new zzdom(this.zzhfp, this.zzhfj, (String) null, zzdog.zzhfm, Collections.emptyList(), zzdvf, (zzdof) null);
    }
    ...
    private final <O> zzdom<O> zza(Callable<O> callable, zzdvi zzdvi) {
        return new zzdom(this.zzhfp, this.zzhfj, (String) null, zzdog.zzhfm, Collections.emptyList(), zzdvi.zze(callable), (zzdof) null);
    }
