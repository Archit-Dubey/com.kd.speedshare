...
public final class zzcrs implements zzcqt<zzbzj> {
    ...
    public final /* synthetic */ zzdvf zza(Uri uri, zzdkw zzdkw, zzdkk zzdkk, Object obj) throws Exception {
        try {
            ...
            zzbzl zza = this.zzgkx.zza(new zzbpr(zzdkw, zzdkk, (String) null), new zzbzk(new zzcru(zzbbn)));
            zzbbn.set(new AdOverlayInfoParcel(zzd, (zzuu) null, zza.zzafx(), (zzt) null, new zzbbd(0, 0, false)));
            this.zzfkk.zzwa();
