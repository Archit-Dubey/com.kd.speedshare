...
final class zzeir implements Comparable<zzeir>, Map.Entry<K, V> {
    private V value;
    private final /* synthetic */ zzeim zziiq;
    private final K zziiu;

    zzeir(zzeim zzeim, Map.Entry<K, V> entry) {
        this(zzeim, (Comparable) entry.getKey(), entry.getValue());
    }
    ...
    public final /* synthetic */ int compareTo(Object obj) {
        return ((Comparable) getKey()).compareTo((Comparable) ((zzeir) obj).getKey());
    }
}
