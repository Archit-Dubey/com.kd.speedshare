...
public class zzare {
    ...
    public static zzawr zzs(Context context) {
        ...
        synchronized (zzare.class) {
            if (zzdou == null) {
                zzdou = zzwg.zzpt().zza(context, (zzamr) new zzamo());
            }
            zzawr = zzdou;
        }
        return zzawr;
    ...
    public final void zza(QueryInfoGenerationCallback queryInfoGenerationCallback) {
        ...
        try {
            zzs.zza(wrap, new zzawx((String) null, this.zzdot.name(), (zzvh) null, zzve), (zzawq) new zzard(this, queryInfoGenerationCallback));
