...
public final class zztm {
    ...
    public final synchronized void zza(zzto.zza.C0014zza zza) {
        if (this.zzbvq) {
    ...
    private final synchronized void zzb(zzto.zza.C0014zza zza) {
        this.zzbvp.zzoc().zzb((Iterable<? extends Long>) zzna());
    ...
    private final synchronized void zzc(zzto.zza.C0014zza zza) {
    ...
    private final synchronized String zzd(zzto.zza.C0014zza zza) {
        return String.format("id=%s,timestamp=%s,event=%s,data=%s\n", new Object[]{this.zzbvp.zznv(), Long.valueOf(zzq.zzld().elapsedRealtime()), Integer.valueOf(zza.zzw()), Base64.encodeToString(((zzty.zzi) ((zzegb) this.zzbvp.zzbfq())).toByteArray(), 3)});
    }
