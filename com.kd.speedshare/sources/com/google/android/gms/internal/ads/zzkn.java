...
public final class zzkn implements zzjx {
    ...
    private static final byte[] zzapd = {49, 10, 48, 48, 58, 48, 48, 58, 48, 48, 44, 48, 48, 48, 32, 45, 45, 62, 32, 48, 48, 58, 48, 48, 58, 48, 48, 44, 48, 48, 48, 10};
    private static final byte[] zzape = {32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32};
    ...
    private zzkn(zzkl zzkl, int i) {
        ...
        this.zzapg = zzkl;
        zzkl.zza(new zzkp(this, (zzkm) null));
        this.zzapi = true;
        this.zzaou = new zzkq();
        this.zzaph = new SparseArray<>();
        this.zzapl = new zzpi(4);
        this.zzapm = new zzpi(ByteBuffer.allocate(4).putInt(-1).array());
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void zza(int r20, int r21, com.google.android.gms.internal.ads.zzjw r22) throws java.io.IOException, java.lang.InterruptedException {
        /*
            r19 = this;
            r0 = r19
            r1 = r20
        ...
        L_0x0287:
            ...
            int[] r2 = r0.zzaqn
            r1 = r2[r1]
            r0.zza((com.google.android.gms.internal.ads.zzjw) r3, (com.google.android.gms.internal.ads.zzko) r4, (int) r1)
            long r1 = r0.zzaqj
            int r5 = r0.zzaql
            int r6 = r4.zzare
            int r5 = r5 * r6
            ...
            long r5 = (long) r5
            long r1 = r1 + r5
            r0.zza((com.google.android.gms.internal.ads.zzko) r4, (long) r1)
            int r1 = r0.zzaql
            r2 = 1
            int r1 = r1 + r2
            r0.zzaql = r1
    ...
    private final void zza(zzko zzko, long j) {
        ...
        if ("S_TEXT/UTF8".equals(zzko.zzard)) {
            ...
            if (j2 == -9223372036854775807L) {
                ...
                bArr = zzpo.zzbj(String.format(Locale.US, "%02d:%02d:%02d,%03d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf((int) ((j4 - ((long) (1000000 * i3))) / 1000))}));
            }
            ...
            if (zzko.zzarf) {
                ...
                if ((b & 1) == 1) {
                    ...
                    if (z) {
                        ...
                        int i5 = (s * 6) + 2;
                        ByteBuffer byteBuffer = this.zzaps;
                        if (byteBuffer == null || byteBuffer.capacity() < i5) {
                            this.zzaps = ByteBuffer.allocate(i5);
                        }
