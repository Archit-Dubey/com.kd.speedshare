...
public final class zzapo extends zzaqd {
    ...
    private String zzdln = zzdu(Constants.RESPONSE_DESCRIPTION);
    private long zzdlo = zzdv("start_ticks");
    private long zzdlp = zzdv("end_ticks");
    private String zzdlq = zzdu("summary");
    ...
    public final void execute() {
        ...
        zzat.setPositiveButton(resources != null ? resources.getString(R.string.s3) : HttpRequest.HEADER_ACCEPT, new zzapr(this));
    ...
    public final Intent createIntent() {
        ...
        data.putExtra(Constants.RESPONSE_DESCRIPTION, this.zzdlq);
        long j = this.zzdlo;
        if (j > -1) {
