...
public final class zzhq implements Parcelable {
    ...
    public static zzhq zza(String str, String str2, String str3, int i, int i2, int i3, int i4, float f, List<byte[]> list, int i5, float f2, byte[] bArr, int i6, zzpt zzpt, zzjl zzjl) {
        return new zzhq(str, (String) null, str2, (String) null, -1, i2, i3, i4, -1.0f, i5, f2, bArr, i6, zzpt, -1, -1, -1, -1, -1, 0, (String) null, -1, Long.MAX_VALUE, list, zzjl, (zzme) null);
    }
    ...
    public static zzhq zza(String str, String str2, String str3, int i, int i2, int i3, int i4, List<byte[]> list, zzjl zzjl, int i5, String str4) {
        return zza(str, str2, (String) null, -1, -1, i3, i4, -1, (List<byte[]>) null, zzjl, 0, str4);
    }
    ...
    public static zzhq zza(String str, String str2, String str3, int i, int i2, int i3, int i4, int i5, List<byte[]> list, zzjl zzjl, int i6, String str4) {
        return new zzhq(str, (String) null, str2, (String) null, -1, i2, -1, -1, -1.0f, -1, -1.0f, (byte[]) null, -1, (zzpt) null, i3, i4, i5, -1, -1, i6, str4, -1, Long.MAX_VALUE, list, zzjl, (zzme) null);
    }

    public static zzhq zza(String str, String str2, String str3, int i, int i2, String str4, zzjl zzjl) {
        return zza(str, str2, (String) null, -1, i2, str4, -1, zzjl, Long.MAX_VALUE, Collections.emptyList());
    }
    ...
    public static zzhq zza(String str, String str2, String str3, int i, int i2, String str4, int i3, zzjl zzjl, long j, List<byte[]> list) {
        return new zzhq(str, (String) null, str2, (String) null, -1, -1, -1, -1, -1.0f, -1, -1.0f, (byte[]) null, -1, (zzpt) null, -1, -1, -1, -1, -1, i2, str4, -1, j, list, zzjl, (zzme) null);
    }
    ...
    public final zzhq zzu(int i) {
        ...
        return new zzhq(str, this.zzagv, this.zzagw, this.zzagt, this.zzags, i, this.width, this.height, this.zzaha, this.zzahb, this.zzahc, this.zzahe, this.zzahd, this.zzahf, this.zzahg, this.zzahh, this.zzahi, this.zzahj, this.zzahk, this.zzahm, this.zzahn, this.zzaho, this.zzahl, this.zzagy, this.zzagz, this.zzagu);
    }
    ...
    public final zzhq zzb(int i, int i2) {
        String str = this.zzagr;
        return new zzhq(str, this.zzagv, this.zzagw, this.zzagt, this.zzags, this.zzagx, this.width, this.height, this.zzaha, this.zzahb, this.zzahc, this.zzahe, this.zzahd, this.zzahf, this.zzahg, this.zzahh, this.zzahi, i, i2, this.zzahm, this.zzahn, this.zzaho, this.zzahl, this.zzagy, this.zzagz, this.zzagu);
    }

    public final zzhq zza(zzjl zzjl) {
        String str = this.zzagr;
        return new zzhq(str, this.zzagv, this.zzagw, this.zzagt, this.zzags, this.zzagx, this.width, this.height, this.zzaha, this.zzahb, this.zzahc, this.zzahe, this.zzahd, this.zzahf, this.zzahg, this.zzahh, this.zzahi, this.zzahj, this.zzahk, this.zzahm, this.zzahn, this.zzaho, this.zzahl, this.zzagy, zzjl, this.zzagu);
    }

    public final zzhq zza(zzme zzme) {
        String str = this.zzagr;
        return new zzhq(str, this.zzagv, this.zzagw, this.zzagt, this.zzags, this.zzagx, this.width, this.height, this.zzaha, this.zzahb, this.zzahc, this.zzahe, this.zzahd, this.zzahf, this.zzahg, this.zzahh, this.zzahi, this.zzahj, this.zzahk, this.zzahm, this.zzahn, this.zzaho, this.zzahl, this.zzagy, this.zzagz, zzme);
    }
    ...
    public final MediaFormat zzez() {
        ...
        mediaFormat.setString(AccessDatabase.FIELD_TRANSFER_MIME, this.zzagw);
