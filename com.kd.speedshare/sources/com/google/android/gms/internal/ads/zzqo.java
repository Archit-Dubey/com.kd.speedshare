...
public final class zzqo implements Application.ActivityLifecycleCallbacks, View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    public zzqo(Context context, View view) {
        ...
        if (context2 instanceof Application) {
            ...
            this.zzbrb = new zzqv((Application) this.zzaah, this);
        }
    ...
    public final void zzbt(int i) {
        ...
        if (this.zzbre.size() != 0 && (weakReference = this.zzbra) != null) {
            ...
            if (z5 || this.zzbrd || i2 != 1) {
                zzqt zzqt = new zzqt(zzq.zzld().elapsedRealtime(), this.zzaai.isScreenOn(), view != null && zzq.zzky().isAttachedToWindow(view), view != null ? view.getWindowVisibility() : 8, zza(this.zzbrf), zza(rect), zza(rect2), z2, zza(rect3), z, zza(rect4), this.zzxc.density, z5, list2);
                Iterator<zzqs> it = this.zzbre.iterator();
                while (it.hasNext()) {
                    it.next().zza(zzqt);
                }
                this.zzbrd = z5;
    ...
    private final void zzg(View view) {
        try {
            if (this.zzaal != null) {
                ViewTreeObserver viewTreeObserver = (ViewTreeObserver) this.zzaal.get();
