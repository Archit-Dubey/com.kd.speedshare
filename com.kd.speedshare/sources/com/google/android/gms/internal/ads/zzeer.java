...
public abstract class zzeer implements Serializable, Iterable<Byte> {
    ...
    private static final zzeex zzhzw = (zzeek.zzbcw() ? new zzefd((zzeeq) null) : new zzeev((zzeeq) null));
    ...
    private static zzeer zza(Iterator<zzeer> it, int i) {
        if (i <= 0) {
