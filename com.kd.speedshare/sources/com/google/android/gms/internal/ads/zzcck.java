...
public final class zzcck {
    ...
    public static zzcck zzb(zzana zzana) {
        try {
            return zza(zza(zzana.getVideoController(), (zzang) null), zzana.zzsd(), (View) zzat(zzana.zztv()), zzana.getHeadline(), zzana.getImages(), zzana.getBody(), zzana.getExtras(), zzana.getCallToAction(), (View) zzat(zzana.zztw()), zzana.zzse(), zzana.getStore(), zzana.getPrice(), zzana.getStarRating(), zzana.zzsc(), (String) null, 0.0f);
        } catch (RemoteException e) {
    ...
    public static zzcck zzb(zzanf zzanf) {
        try {
            return zza(zza(zzanf.getVideoController(), (zzang) null), zzanf.zzsd(), (View) zzat(zzanf.zztv()), zzanf.getHeadline(), zzanf.getImages(), zzanf.getBody(), zzanf.getExtras(), zzanf.getCallToAction(), (View) zzat(zzanf.zztw()), zzanf.zzse(), (String) null, (String) null, -1.0d, zzanf.zzsf(), zzanf.getAdvertiser(), 0.0f);
        } catch (RemoteException e) {
