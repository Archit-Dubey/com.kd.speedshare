                ...
                if (findPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (z) {
                            ...
                            int i8 = scrollY + i7;
                            if (i8 < 0) {
                                EdgeEffectCompat.onPull(this.mEdgeGlowTop, ((float) i7) / ((float) getHeight()), motionEvent2.getX(i5) / ((float) getWidth()));
                                ...
                                int i9 = i5;
                                if (i8 > i4) {
                                    EdgeEffectCompat.onPull(this.mEdgeGlowBottom, ((float) i7) / ((float) getHeight()), 1.0f - (motionEvent2.getX(i9) / ((float) getWidth())));
