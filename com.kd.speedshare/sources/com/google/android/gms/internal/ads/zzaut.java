...
public final class zzaut {
    ...
    public final void zza(zzyq zzyq, RewardedAdLoadCallback rewardedAdLoadCallback) {
        try {
            this.zzduu.zza(zzvf.zza(this.zzaah, zzyq), (zzauq) new zzava(rewardedAdLoadCallback));
    ...
    public final void setOnAdMetadataChangedListener(OnAdMetadataChangedListener onAdMetadataChangedListener) {
        try {
            this.zzduu.zza((zzxx) new zzzs(onAdMetadataChangedListener));
        } catch (RemoteException e) {
            zzbba.zze("#007 Could not call remote method.", e);
        }
    }
    ...
    public final void show(Activity activity, RewardedAdCallback rewardedAdCallback) {
        try {
            this.zzduu.zza((zzauj) new zzauv(rewardedAdCallback));
    ...
    public final void setOnPaidEventListener(OnPaidEventListener onPaidEventListener) {
        try {
            this.zzduu.zza((zzyc) new zzzv(onPaidEventListener));
        } catch (RemoteException e) {
            zzbba.zze("#007 Could not call remote method.", e);
        }
    }
