...
public final class CameraConfigurationUtils {
    ...
    public static void setInvertColor(Camera.Parameters parameters) {
        if (DialogEventReceiver.EXTRA_NEGATIVE_INTENT.equals(parameters.getColorEffect())) {
            Log.i(TAG, "Negative effect already set");
            return;
        }
        String findSettableValue = findSettableValue("color effect", parameters.getSupportedColorEffects(), DialogEventReceiver.EXTRA_NEGATIVE_INTENT);
        if (findSettableValue != null) {
