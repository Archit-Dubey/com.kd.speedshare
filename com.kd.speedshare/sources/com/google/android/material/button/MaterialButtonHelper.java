...
class MaterialButtonHelper {
    ...
    public void loadFromAttributes(TypedArray typedArray) {
        ...
        if (typedArray.hasValue(R.styleable.MaterialButton_cornerRadius)) {
            ...
            this.shapeAppearanceModel.setCornerRadius((float) dimensionPixelSize);
    ...
    private Drawable createBackground() {
        ...
        if (IS_LOLLIPOP) {
            ...
            RippleDrawable rippleDrawable2 = new RippleDrawable(RippleUtils.convertToRippleDrawableColor(this.rippleColor), wrapDrawableWithInset(new LayerDrawable(new Drawable[]{materialShapeDrawable2, materialShapeDrawable})), this.maskDrawable);
