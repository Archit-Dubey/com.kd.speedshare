...
public class BillingProcessor extends BillingBase {
    ...
    public boolean purchase(Activity activity, String str) {
        return purchase(activity, (List<String>) null, str, Constants.PRODUCT_TYPE_MANAGED, (String) null);
    }

    public boolean subscribe(Activity activity, String str) {
        return purchase(activity, (List<String>) null, str, Constants.PRODUCT_TYPE_SUBSCRIPTION, (String) null);
    }
    ...
    public boolean purchase(Activity activity, String str, String str2, Bundle bundle) {
        ...
        return purchase(activity, (List<String>) null, str, Constants.PRODUCT_TYPE_MANAGED, str2, bundle);
    }
    ...
    public boolean subscribe(Activity activity, String str, String str2, Bundle bundle) {
        ...
        return purchase(activity, (List<String>) null, str, Constants.PRODUCT_TYPE_SUBSCRIPTION, str2, bundle);
    }
    ...
    public boolean isSubscriptionWithExtraParamsSupported(Bundle bundle) {
        ...
        try {
            if (this.billingService.isBillingSupportedExtraParams(7, this.contextPackageName, Constants.PRODUCT_TYPE_SUBSCRIPTION, bundle) != 0) {
                z = false;
            }
    ...
    public boolean isOneTimePurchaseWithExtraParamsSupported(Bundle bundle) {
        ...
        try {
            if (this.billingService.isBillingSupportedExtraParams(7, this.contextPackageName, Constants.PRODUCT_TYPE_MANAGED, bundle) != 0) {
                z = false;
            }
    ...
    public boolean updateSubscription(Activity activity, List<String> list, String str, String str2, Bundle bundle) {
        ...
        return purchase(activity, list, str, Constants.PRODUCT_TYPE_SUBSCRIPTION, str2, bundle);
    }
    ...
    private boolean purchase(Activity activity, List<String> list, String str, String str2, String str3, Bundle bundle) {
        ...
        if (isInitialized() && !TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
            try {
                ...
                if (!str6.equals(Constants.PRODUCT_TYPE_SUBSCRIPTION)) {
                ...
                if (list2 == null || !str6.equals(Constants.PRODUCT_TYPE_SUBSCRIPTION)) {
                    ...
                    if (!bundle3.containsKey(Constants.EXTRA_PARAMS_KEY_SKU_TO_REPLACE)) {
                        bundle3.putStringArrayList(Constants.EXTRA_PARAMS_KEY_SKU_TO_REPLACE, new ArrayList(list2));
                    }
        ...
        if (i2 == -1 && intExtra == 0) {
            ...
            try {
                ...
                if (verifyPurchaseSignature(string, stringExtra, stringExtra2)) {
                    (detectPurchaseTypeFromPurchaseResponseData(jSONObject).equals(Constants.PRODUCT_TYPE_SUBSCRIPTION) ? this.cachedSubscriptions : this.cachedProducts).put(string, stringExtra, stringExtra2);
