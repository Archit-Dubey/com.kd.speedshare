...
public final class zzbde {
    ...
    public final void onStop() {
        if (zzacx.zzdbo.get().booleanValue() && !this.zzeib) {
            ...
            bundle.putString(Keyword.REQUEST, this.zzdpt);
            bundle.putString("player", this.zzeia.zzyo());
            for (zzazo next : this.zzeht.zzxy()) {
                ...
                bundle.putString(valueOf2.length() != 0 ? "fps_p_".concat(valueOf2) : new String("fps_p_"), Double.toString(next.zzebg));
            }
            int i = 0;
            while (true) {
    ...
    public final void zzc(zzbcm zzbcm) {
        ...
        if (this.zzeff && this.zzeic && this.zzeid != -1) {
            ...
            double d = (double) (nanoTime - this.zzeid);
            Double.isNaN(nanos);
            Double.isNaN(d);
            this.zzeht.zza(nanos / d);
        }
