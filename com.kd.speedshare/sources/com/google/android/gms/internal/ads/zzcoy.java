...
public final class zzcoy extends zzasc {
    ...
    public final zzdvf<InputStream> zzb(zzasm zzasm, int i) {
        ...
        zzalj<I, O> zza3 = zza.zza("google.afma.response.normalize", zzcpm.zzgiq, zzalm.zzdhg);
        ...
        if (zzcpn == null) {
            ...
            zzdod zzaus = zzafd.zza(zzdor.HTTP, (zzdvf<?>[]) new zzdvf[]{zza5, zza4}).zzb(new zzcpb(zza4, zza5)).zzb(zzcpr).zzaus();
            return zzafd.zza(zzdor.PRE_PROCESS, (zzdvf<?>[]) new zzdvf[]{zza4, zza5, zzaus}).zzb(new zzcpa(zzaus, zza4, zza5)).zza(zza3).zzaus();
        }
        ...
        return zzafd.zza(zzdor.PRE_PROCESS, (zzdvf<?>[]) new zzdvf[]{zzaus2, zzaf}).zzb(new zzcpd(zzaus2, zzaf)).zza(zza3).zzaus();
    }
    ...
    public final zzdvf<InputStream> zzc(zzasm zzasm, int i) {
        ...
        return zzafd.zza(zzdor.GET_URL_AND_CACHE_KEY, (zzdvf<?>[]) new zzdvf[]{zza3, zza4}).zzb(new zzcpg(this, zza4, zza3)).zzaus();
    }
    ...
    private final void zza(zzdvf<InputStream> zzdvf, zzasg zzasg) {
        zzdux.zza(zzdux.zzb(zzdvf, new zzcpi(this), (Executor) zzbbf.zzedh), new zzcpk(this, zzasg), zzbbf.zzedm);
    }
