        ...
        try {
            ...
            if (!this.zzgmz.zzabo()) {
                ...
                if (!((Boolean) zzwg.zzpw().zzd(zzaav.zzcnu)).booleanValue()) {
                    ...
                    zzahn.zza(zzc, (zzahm) zzchl.zzagd());
                    zzcim zzcim = new zzcim();
                    zzcim.zzc(this.zzvr, zzc.getView());
                    zzchl.zzafj().zzb(zzc, true);
                    zzc.zzaaz().zza((zzbhc) new zzcut(zzcim, zzc));
                    zzbgz zzaaz = zzc.zzaaz();
                    zzc.getClass();
                    zzaaz.zza(zzcus.zzq(zzc));
                    zzc.zzb(zzdkk.zzgzr.zzdof, zzdkk.zzgzr.zzdoh, (String) null);
                    zzbfn = zzc;
                    zzbfn.zzax(true);
                    zzq.zzkw();
                    ...
                    zzn.zza(context2, new AdOverlayInfoParcel((zzuu) null, (zzo) zzchl.zzafy(), (zzt) null, zzbfn, this.zzfol.zzgzz, this.zzbov, this.zzfol.zzdrk, zzg, this.zzfol.zzgzr.zzdof, this.zzfol.zzgzr.zzdoh), true);
                }
            }
            zzbfn = zzbfn2;
            zzbfn.zzax(true);
            ...
            zzn.zza(context22, new AdOverlayInfoParcel((zzuu) null, (zzo) zzchl.zzafy(), (zzt) null, zzbfn, this.zzfol.zzgzz, this.zzbov, this.zzfol.zzdrk, zzg2, this.zzfol.zzgzr.zzdof, this.zzfol.zzgzr.zzdoh), true);
        } catch (zzbfz e) {
            zzbba.zzc("", e);
        }
    }
