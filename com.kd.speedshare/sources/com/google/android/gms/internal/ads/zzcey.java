...
public final class zzcey {
    ...
    private final zzdvf<zzadf> zza(JSONObject jSONObject, boolean z) {
        ...
        if (z) {
            return zzdux.zzaf(new zzadf((Drawable) null, Uri.parse(optString), optDouble, optInt, optInt2));
        }
    ...
    public final zzdvf<zzbfn> zzm(JSONObject jSONObject) {
        ...
        return zzdux.zzb(zzo, new zzcff(zzo), (Executor) zzbbf.zzedm);
    }

    private static <T> zzdvf<T> zza(zzdvf<T> zzdvf, T t) {
        return zzdux.zzb(zzdvf, Exception.class, new zzcfe((Object) null), zzbbf.zzedm);
    }

    private static <T> zzdvf<T> zza(boolean z, zzdvf<T> zzdvf, T t) {
        if (z) {
            return zzdux.zzb(zzdvf, new zzcfh(zzdvf), (Executor) zzbbf.zzedm);
        }
    ...
    public final /* synthetic */ zzdvf zzb(String str, Object obj) throws Exception {
        zzq.zzkx();
        zzbfn zza = zzbfv.zza(this.zzvr, zzbhg.zzacp(), "native-omid", false, false, this.zzemz, this.zzboy, (zzabi) null, (zzi) null, this.zzgar, this.zzelk, (zzso) null, false);
        zzbbo zzl = zzbbo.zzl(zza);
        zza.zzaaz().zza((zzbhc) new zzcfg(zzl));
    ...
    public final /* synthetic */ zzada zza(JSONObject jSONObject, List list) {
        ...
        String optString = jSONObject.optString(AccessDatabase.FIELD_CLIPBOARD_TEXT);
