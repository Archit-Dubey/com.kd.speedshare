...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, ShapeAppearanceModel.OnChangedListener {
    ...
    private int layerElevationOverlayIfNeeded(int i) {
        return this.drawableState.elevationOverlayProvider != null ? this.drawableState.elevationOverlayProvider.layerOverlayIfNeeded(i, this.drawableState.elevation) : i;
    }
    ...
    public void setElevation(float f) {
        if (this.drawableState.elevation != f) {
            this.drawableState.shadowCompatRadius = (int) Math.ceil((double) (SHADOW_RADIUS_MULTIPLIER * f));
            this.drawableState.shadowCompatOffset = (int) Math.ceil((double) (SHADOW_OFFSET_MULTIPLIER * f));
    ...
    private void prepareCanvasForShadow(Canvas canvas) {
        ...
        Double.isNaN(d);
        int i = (int) (d * sin);
        double d2 = (double) this.drawableState.shadowCompatOffset;
