...
public final class zzecj implements zzdwc {
    ...
    public final byte[] zzc(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        if (length <= (Integer.MAX_VALUE - i) - 16) {
            ...
            System.arraycopy(zzfn, 0, bArr4, 0, this.zzhxd);
            Cipher cipher = zzhwz.get();
            cipher.init(1, this.zzhws);
            ...
            cipher2.doFinal(bArr, 0, bArr3.length, bArr4, this.zzhxd);
            byte[] zza3 = zza(cipher, 2, bArr4, this.zzhxd, bArr3.length);
            int length2 = bArr3.length + this.zzhxd;
