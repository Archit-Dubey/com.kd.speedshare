...
public final class zzbae {
    ...
    public static org.json.JSONObject zza(android.content.Context r16, android.view.View r17) {
        ...
        L_0x005b:
            ...
            r9.put((java.lang.String) r7, (int) r14)     // Catch:{ Exception -> 0x00dd }
            int r14 = r17.getMeasuredHeight()     // Catch:{ Exception -> 0x00dd }
            int r14 = zzb((android.content.Context) r0, (int) r14)     // Catch:{ Exception -> 0x00dd }
            r9.put((java.lang.String) r6, (int) r14)     // Catch:{ Exception -> 0x00dd }
            r14 = r12[r11]     // Catch:{ Exception -> 0x00dd }
            int r14 = zzb((android.content.Context) r0, (int) r14)     // Catch:{ Exception -> 0x00dd }
            r9.put((java.lang.String) r5, (int) r14)     // Catch:{ Exception -> 0x00dd }
            r14 = r12[r10]     // Catch:{ Exception -> 0x00dd }
            int r14 = zzb((android.content.Context) r0, (int) r14)     // Catch:{ Exception -> 0x00dd }
            r9.put((java.lang.String) r4, (int) r14)     // Catch:{ Exception -> 0x00dd }
            ...
            r9.put((java.lang.String) r14, (int) r15)     // Catch:{ Exception -> 0x00dd }
            ...
            r9.put((java.lang.String) r14, (int) r13)     // Catch:{ Exception -> 0x00dd }
            r9.put((java.lang.String) r3, (java.lang.Object) r2)     // Catch:{ Exception -> 0x00dd }
            java.lang.String r13 = "frame"
            r8.put((java.lang.String) r13, (java.lang.Object) r9)     // Catch:{ Exception -> 0x00dd }
        ...
        L_0x00b6:
            org.json.JSONObject r9 = new org.json.JSONObject     // Catch:{ Exception -> 0x00dd }
            r9.<init>()     // Catch:{ Exception -> 0x00dd }
            r9.put((java.lang.String) r7, (int) r11)     // Catch:{ Exception -> 0x00dd }
            r9.put((java.lang.String) r6, (int) r11)     // Catch:{ Exception -> 0x00dd }
            r6 = r12[r11]     // Catch:{ Exception -> 0x00dd }
            int r6 = zzb((android.content.Context) r0, (int) r6)     // Catch:{ Exception -> 0x00dd }
            r9.put((java.lang.String) r5, (int) r6)     // Catch:{ Exception -> 0x00dd }
            r5 = r12[r10]     // Catch:{ Exception -> 0x00dd }
            int r0 = zzb((android.content.Context) r0, (int) r5)     // Catch:{ Exception -> 0x00dd }
            r9.put((java.lang.String) r4, (int) r0)     // Catch:{ Exception -> 0x00dd }
            r9.put((java.lang.String) r3, (java.lang.Object) r2)     // Catch:{ Exception -> 0x00dd }
            r0 = r9
        L_0x00d7:
            java.lang.String r2 = "visible_bounds"
            r8.put((java.lang.String) r2, (java.lang.Object) r0)     // Catch:{ Exception -> 0x00dd }
            goto L_0x00e2
        L_0x00dd:
        ...
        L_0x013e:
            ...
            r8.put((java.lang.String) r0, (int) r11)     // Catch:{ JSONException -> 0x0151 }
            goto L_0x0157
        L_0x0148:
            r1 = 2
            r8.put((java.lang.String) r0, (int) r1)     // Catch:{ JSONException -> 0x0151 }
            goto L_0x0157
        L_0x014d:
            r8.put((java.lang.String) r0, (int) r10)     // Catch:{ JSONException -> 0x0151 }
            goto L_0x0157
        L_0x0151:
            r0 = move-exception
            ...
            while (it.hasNext()) {
                ...
                if (view2 != null) {
                    ...
                    try {
                        ...
                        jSONObject4.put(str4, (Object) str3);
                        ...
                        if (view2 instanceof TextView) {
                            ...
                            try {
                                ...
                                jSONObject3.put(AccessDatabase.FIELD_CLIPBOARD_TEXT, (Object) textView.getText());
                            } catch (JSONException unused) {
    ...
    public static JSONObject zza(String str, Context context, Point point, Point point2) {
        ...
        try {
            JSONObject jSONObject2 = new JSONObject();
            try {
                jSONObject2.put("click_point", (Object) zza(context, point, point2));
                jSONObject2.put("asset_id", (Object) str);
                return jSONObject2;
            } catch (Exception e) {
                e = e;
    ...
    public static JSONObject zzbm(@Nonnull Context context) {
        ...
        try {
            jSONObject.put("width", zzb(context, zzas.widthPixels));
            jSONObject.put("height", zzb(context, zzas.heightPixels));
            return jSONObject;
        } catch (JSONException unused) {
            return null;
        }
