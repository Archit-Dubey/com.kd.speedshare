...
public class zzaqd {
    ...
    public final void zzdw(String str) {
        try {
            JSONObject put = new JSONObject().put(DialogEventReceiver.EXTRA_MESSAGE, (Object) str).put("action", (Object) this.zzdmx);
            if (this.zzdfp != null) {
    ...
    public final void zzdx(String str) {
        try {
            this.zzdfp.zzb("onReadyEventReceived", new JSONObject().put("js", (Object) str));
        } catch (JSONException e) {
    ...
    public final void zzb(int i, int i2, int i3, int i4) {
        try {
            this.zzdfp.zzb("onSizeChanged", new JSONObject().put("x", i).put("y", i2).put("width", i3).put("height", i4));
        } catch (JSONException e) {
    ...
    public final void zzc(int i, int i2, int i3, int i4) {
        try {
            this.zzdfp.zzb("onDefaultPositionReceived", new JSONObject().put("x", i).put("y", i2).put("width", i3).put("height", i4));
        } catch (JSONException e) {
    ...
    public final void zzdy(String str) {
        try {
            this.zzdfp.zzb("onStateChanged", new JSONObject().put("state", (Object) str));
        } catch (JSONException e) {
    ...
    public final void zza(int i, int i2, int i3, int i4, float f, int i5) {
        try {
            this.zzdfp.zzb("onScreenInfoChanged", new JSONObject().put("width", i).put("height", i2).put("maxSizeWidth", i3).put("maxSizeHeight", i4).put("density", (double) f).put("rotation", i5));
        } catch (JSONException e) {
