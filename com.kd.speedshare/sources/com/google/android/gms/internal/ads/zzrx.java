...
public final class zzrx {
    public static void zza(String[] strArr, int i, int i2, PriorityQueue<zzrw> priorityQueue) {
        ...
        for (int i4 = 1; i4 < (strArr2.length - i3) + 1; i4++) {
            ...
            zzb = (((((j - ((((((long) zzrs.zzbu(strArr2[i4 - 1])) + 2147483647L) % 1073807359) * zza) % 1073807359)) % 1073807359) * 16785407) % 1073807359) + ((((long) zzrs.zzbu(strArr2[(i4 + i3) - 1])) + 2147483647L) % 1073807359)) % 1073807359;
