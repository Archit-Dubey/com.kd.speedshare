...
.method final synthetic zza(Landroid/view/View;Landroid/view/WindowManager;Lcom/google/android/gms/internal/ads/zzdkk;Lcom/google/android/gms/internal/ads/zzbfn;Ljava/util/Map;)V
    ...
    :try_end_75
    .catch Ljava/lang/NumberFormatException; {:try_start_4e .. :try_end_75} :catch_76
    ...
    :try_end_b8
    .catch Ljava/lang/NumberFormatException; {:try_start_91 .. :try_end_b8} :catch_b8
    ...
    :try_end_f9
    .catch Ljava/lang/NullPointerException; {:try_start_c3 .. :try_end_f9} :catch_fa
    ...
    packed-switch v13, :pswitch_data_236
    ...
    if-eq v13, v12, :cond_1a1

    if-eq v13, v14, :cond_19a

    const/4 v12, 0x3

    if-eq v13, v12, :cond_19a

    const/4 v12, 0x4

    if-eq v13, v12, :cond_184
