...
public final class zzdpd {
    ...
    public final void zza(zzdkw zzdkw, zzdkk zzdkk, boolean z, String str, String str2, List<String> list) {
        ...
        String str3 = z ? "1" : "0";
        for (String zzc : list) {
            String zzc2 = zzc(zzc(zzc(zzc, "@gw_adlocid@", zzdkw.zzhat.zzfpv.zzhaz), "@gw_adnetrefresh@", str3), "@gw_sdkver@", this.zzbpn);
            if (zzdkk != null) {
                zzc2 = zzawn.zzc(zzc(zzc(zzc(zzc2, "@gw_qdata@", zzdkk.zzdil), "@gw_adnetid@", zzdkk.zzagr), "@gw_allocid@", zzdkk.zzdjb), this.zzvr, zzdkk.zzdsh);
            }
            String zzc3 = zzc(zzc(zzc(zzc2, "@gw_adnetstatus@", this.zzftc.zzapp()), "@gw_seqnum@", this.zzdpm), "@gw_sessid@", this.zzcio);
            boolean z2 = ((Boolean) zzwg.zzpw().zzd(zzaav.zzcqz)).booleanValue() && !TextUtils.isEmpty(str);
            boolean isEmpty = true ^ TextUtils.isEmpty(str2);
            if (z2 || isEmpty) {
                if (this.zzfkq.zzb(Uri.parse(zzc3))) {
    ...
    public final void zza(zzdkw zzdkw, zzdkk zzdkk, List<String> list, zzatg zzatg) {
        ...
        try {
            ...
            for (String zzc : list) {
                arrayList.add(zzawn.zzc(zzc(zzc(zzc(zzc(zzc(zzc(zzc, "@gw_rwd_userid@", Uri.encode(zzgx)), "@gw_rwd_custom_data@", Uri.encode(str)), "@gw_tmstmp@", Long.toString(currentTimeMillis)), "@gw_rwd_itm@", Uri.encode(type)), "@gw_rwd_amt@", num), "@gw_sdkver@", this.zzbpn), this.zzvr, zzdkk.zzdsh));
            }
            zzi(arrayList);
