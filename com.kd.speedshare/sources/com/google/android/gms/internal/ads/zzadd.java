...
public final class zzadd extends RelativeLayout {
    ...
    public zzadd(Context context, zzada zzada, RelativeLayout.LayoutParams layoutParams) {
        ...
        ShapeDrawable shapeDrawable = new ShapeDrawable(new RoundRectShape(zzdcb, (RectF) null, (float[]) null));
        ...
        if (zzru != null && zzru.size() > 1) {
            ...
            for (zzadf zzry : zzru) {
                try {
                    this.zzdcc.addFrame((Drawable) ObjectWrapper.unwrap(zzry.zzry()), zzada.zzrv());
                } catch (Exception e) {
