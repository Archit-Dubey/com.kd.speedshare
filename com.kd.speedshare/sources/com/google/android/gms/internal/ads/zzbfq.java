...
public class zzbfq extends WebViewClient implements zzbgz {
    ...
    public zzbfq(zzbfn zzbfn, zztm zztm, boolean z) {
        this(zzbfn, zztm, z, new zzaqa(zzbfn, zzbfn.zzaau(), new zzaac(zzbfn.getContext())), (zzapt) null);
    }
    ...
    public final void zza(zzuu zzuu, zzagi zzagi, zzo zzo, zzagk zzagk, zzt zzt, boolean z, zzahf zzahf, zzc zzc, zzaqc zzaqc, zzavr zzavr) {
        if (zzc == null) {
            zzc = new zzc(this.zzelj.getContext(), zzavr, (zzarx) null);
        }
        this.zzdef = new zzapt(this.zzelj, zzaqc);
        this.zzelu = zzavr;
        if (((Boolean) zzwg.zzpw().zzd(zzaav.zzcoa)).booleanValue()) {
            zza("/adMetadata", (zzahc<? super zzbfn>) new zzagj(zzagi));
        }
        zza("/appEvent", (zzahc<? super zzbfn>) new zzagl(zzagk));
        zza("/backButton", (zzahc<? super zzbfn>) zzagm.zzddu);
        zza("/refresh", (zzahc<? super zzbfn>) zzagm.zzddv);
        zza("/canOpenApp", (zzahc<? super zzbfn>) zzagm.zzddl);
        zza("/canOpenURLs", (zzahc<? super zzbfn>) zzagm.zzddk);
        zza("/canOpenIntents", (zzahc<? super zzbfn>) zzagm.zzddm);
        zza("/click", (zzahc<? super zzbfn>) zzagm.zzddn);
        zza("/close", (zzahc<? super zzbfn>) zzagm.zzddo);
        zza("/customClose", (zzahc<? super zzbfn>) zzagm.zzddp);
        zza("/instrument", (zzahc<? super zzbfn>) zzagm.zzddy);
        zza("/delayPageLoaded", (zzahc<? super zzbfn>) zzagm.zzdea);
        zza("/delayPageClosed", (zzahc<? super zzbfn>) zzagm.zzdeb);
        zza("/getLocationInfo", (zzahc<? super zzbfn>) zzagm.zzdec);
        zza("/httpTrack", (zzahc<? super zzbfn>) zzagm.zzddq);
        zza("/log", (zzahc<? super zzbfn>) zzagm.zzddr);
        zza("/mraid", (zzahc<? super zzbfn>) new zzahh(zzc, this.zzdef, zzaqc));
        zza("/mraidLoaded", (zzahc<? super zzbfn>) this.zzelt);
        zza("/open", (zzahc<? super zzbfn>) new zzahg(zzc, this.zzdef));
        zza("/precache", (zzahc<? super zzbfn>) new zzbex());
        zza("/touch", (zzahc<? super zzbfn>) zzagm.zzddt);
        zza("/video", (zzahc<? super zzbfn>) zzagm.zzddw);
        zza("/videoMeta", (zzahc<? super zzbfn>) zzagm.zzddx);
        if (zzq.zzlu().zzac(this.zzelj.getContext())) {
            zza("/logScionEvent", (zzahc<? super zzbfn>) new zzahe(this.zzelj.getContext()));
        }
        this.zzcgl = zzuu;
        this.zzdoe = zzo;
        this.zzddi = zzagi;
    ...
    public final void zzacb() {
        ...
        if (zztm != null) {
            zztm.zza(zzto.zza.C0014zza.DELAY_PAGE_LOAD_CANCELLED_AD);
        }
        this.zzelw = true;
        zzacc();
    ...
    public final void zza(boolean z, int i, String str) {
        ...
        zzt zzt = this.zzdoi;
        zzbfn zzbfn = this.zzelj;
        zza(new AdOverlayInfoParcel(zzuu, (zzo) zzbfw, zzagi, zzagk, zzt, zzbfn, z, i, str, zzbfn.zzzo()));
    }
    ...
    public final void zza(String str, Predicate<zzahc<? super zzbfn>> predicate) {
        synchronized (this.lock) {
            List<zzahc> list = this.zzell.get(str);
            if (list != null) {
    ...
    public final void zzh(Uri uri) {
        ...
        List list = this.zzell.get(path);
        if (list != null) {
            if (!((Boolean) zzwg.zzpw().zzd(zzaav.zzcuk)).booleanValue()) {
                zzq.zzkw();
                zza(zzaye.zzj(uri), (List<zzahc<? super zzbfn>>) list, path);
                return;
            }
    ...
    public final void zza(Map<String, String> map, List<zzahc<? super zzbfn>> list, String str) {
        ...
        for (zzahc<? super zzbfn> zza : list) {
            zza.zza(this.zzelj, map);
        }
    }
