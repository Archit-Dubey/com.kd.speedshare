...
public final class zzayv {
    ...
    public final /* synthetic */ void zza(String str, DialogInterface dialogInterface, int i) {
        zzq.zzkw();
        zzaye.zza(this.zzvr, Intent.createChooser(new Intent("android.intent.action.SEND").setType(NanoHTTPD.MIME_PLAINTEXT).putExtra("android.intent.extra.TEXT", str), "Share via"));
    }
    ...
    public final /* synthetic */ void zza(int r1, int r2, int r3, android.content.DialogInterface r4, int r5) {
        ...
        L_0x000e:
            ...
            java.util.Map r1 = com.google.android.gms.internal.ads.zzaye.zzj((android.net.Uri) r1)
